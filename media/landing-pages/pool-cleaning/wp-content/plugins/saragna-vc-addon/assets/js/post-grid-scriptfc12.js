function sa_vc_add_animation($this, animation) {
...
function sa_vc_imag_animation(){
	jQuery('[svc-animation]').each(function () {
		var animation_style = jQuery(this).attr('svc-animation');
		sa_vc_add_animation(jQuery(this), animation_style);
	});
}
function sa_vc_addLoadEvent(func) {
