    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        function addSlidesNavigation(section, numSlides){
            ...
            var secID=section.context.id;

            for(var i=0; i< numSlides; i++){
                var scount;
                scount=i+1;
                var mslideData= section.find( "#mslide"+scount ).data( "tooltip");
               // var mslideData=$( "#mslide"+scount ).data( "tooltip");
                if(typeof mslideData == 'undefined'){
                    mslideData="Slide"+scount;
                }
                
                nav.find('ul').append('<li><a href="#"><span></span></a><div class="fp-tooltiptop" style="display:none">'+mslideData+'</div></li>');
            }
