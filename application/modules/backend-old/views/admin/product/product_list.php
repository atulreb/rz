                        ...
                        if (!empty($arr_product_data)) {
                            foreach ($arr_product_data as $post) {
                                ...
                                <tr>
                                    ...
                                    <td class="worktd"  align="left"><?php echo stripslashes($post['sku']); ?></td>
                                    <td class="worktd"  align="left"><?php echo stripslashes($post['price']); ?></td>
                                    <td class="worktd"  align="left"><?php echo stripslashes($post['stock']); ?></td>
                                    <td class="worktd"  align="left"><?php
                                        if ($post['status'] == '1')
                                            ...
                                            echo 'Inactive';
                                        ?></td>
                                    <td><a title="Edit Sub Category Details" href="<?php echo base_url(); ?>#" class="btn btn-info"><i class="fa fa-edit"></i></a></td>
