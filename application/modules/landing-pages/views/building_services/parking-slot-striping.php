...
<script>    
    ...
    <div class="sixty">
        <div class="ilblock">
            <h1 class="sub_title">RazorClean building services Parking Lot Striping Services</h1>
            <p>No matter the size of the project Razorclean building services have the capacity to meet many needs of parking lots and striping requirements.</p>
            <div class="spacer"></div>
            <div></div>
            <img class="fifty" src="<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/2016/07/Clean-Parking-Lot-3x2-200.jpg" alt="parking lot striping" />
            <div class="forty">
                <h3 class="title-description" style="text-align: left;">Our parking lot experts can handle:</h3>
                <ul style="text-align: left;">
                    <li>Parking Lot Striping</li>
                    <li>New Layouts</li>
                    <li>Traffic Buttons, Markers, and Reflectors</li>
                    <li>Warehouse Floor Striping</li>
                    <li>Athletic Field Striping</li>
                    <li>Surface Logos</li>
                    <li>Preformed Thermo Plastic</li>
                    <li>Wheel Stops</li>
                    <li>Speed Bumps</li>
                    <li>Pressure Washing</li>
                    <li>Sand Blasting</li>
                    <li>Signage</li>
                    <li>Barrier poles – Bollards</li>
                </ul>
            </div>
            <div class="spacer"></div>
            <img src="<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/2016/07/Striped-Parking-Lot-3x2-200.jpg" alt="striped parking lot" />
        </div>
    </div>
</div>
