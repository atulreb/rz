                ...
                <h4 class="banner_home_button_link" style="padding:0 !important">RazorClean INc.</h4>
                        ...
                        <div class="sixty read_more">
                            <div class="ilblock">
                                ...
                                <p>A clean and professional looking facility will attract more people to visit, lease, and stay. One of the best ways to get that first positive impression is by regular scheduled power washing. </p>
                                <p>RazorClean Building Services has the equipment and expertise to handle any size power washing job you might need on your property. Our team of trained professionals provides a wide range of exterior and interior power washing services for your building. We use the latest in trailer mount power washing technology to carry out all different types and size jobs.</p>
                                
                                <!-- -->
                                <div class="spacer"></div>
                                <div></div><img class="fifty" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_pw1.jpg" alt="Truck with power washing equipment attached" />
                                <!-- -->
                                <div class="forty">
                                ...
                                <p>Our professional equipment gives us the flexibility to handle the most delicate and most tough jobs all while making sure your property is left clean and undamaged. We always take the most cautious approach to cleaning, starting with low pressure and working our way up, if necessary. Try us, we promise you'll agree that we are the best at power washing. RazorClean The Circle Of Trust. </p>
                                <div class="spacer"></div>
                                <img class="fifty" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_pw2.jpg" alt="Power washing wearing a yellow tyvec suit" />
                                <ul class="forty">
                                    <li>Tire Marks</li>
                                ...
                                <p>We have a fleet of mounted trailers, heated power washing units; these units are widely considered the best in the industry. We also have multiple capabilities including 300-gallon water and recovery tanks, lifts and hundreds of feet of hose for the hard to access areas.</p>
