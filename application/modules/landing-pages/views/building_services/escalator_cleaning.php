                ...
                <h4 class="banner_home_button_link" style="padding:0 !important">RazorClean INc.</h4>
                        ...
                        <div class="sixty">
                            <div class="info_block">
                                <h1>RazorClean Escalator Cleaning</h1>
                                <h3>Exceptional service that you can trust. 
RazorClean The Circle Of Trust.</h3>
                                <p>There are about 35,000 escalators operating in the U.S. - far fewer than the number of elevators. But injuries occur far more frequently on escalators, about 15 times more frequently.  </p>
                                <img class="seventy" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_ec1.jpg" alt="Clean Office" />
                                <img class="seventy" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_ec2.jpg" alt="Clean Office" />
                                <p>Escalator Slip and Fall Accidents in the US Escalator accidents due to infrequent cleaning or unresolved slippery surfaces are a serious safety concern that can also open the door to legal exposure and liability. Hazardous conditions leading to accidents places liability on property owners and property managers based on general slip and fall legal doctrines of each state. </p>
</p><img class="fourty" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_ec3.jpg" alt="Clean Office" />
                                <p>Slip and falls are mainly caused by slippery surfaces.  The walking surface of an escalators treads can accumulate a thin ?lm of oil or grease during normal operation. This happens as the treads rotate upside down and pass directly over the operating mechanics of the escalator beneath. A thin ?lm of oily residue is deposited on the surfaces of the treads, which creates the dangerous surface. This can then be compounded by a spilled drink, increasing the likelihood of a slip and fall accident even more dramatically. </p>
                                <p>The REN cleaning pad images below show the amount of dirt and grease removed after just one 3-minute cleaning cycle on an escalator that had been serviced only one month prior.  </p>
                                <p>We provide a RazorClean knowledgeable, conscientious, and thoroughly introduction of a unique, purpose designed automatic escalator scrubber and drier. When's the last time you cleaned your escalators? RBS uses renclean products regarding its Escalator Cleaning. </p>
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/GaEeyXc15XM" frameborder="0" allowfullscreen></iframe>
                                <br>
                                <a href="javascript:;">Contact us for further information at 1 (855) GO RZCLN (467) (9256).RazorClean, The Circle Of Trust, Save Money Live RazorClean.</a>
                                <style>
                                    #read_more_toggle
                                    {
                                        background-color: #bd252c;
