...
<div class="sixty">
    <div class="info_block">
        ...
        <p>Knight Janitorial specializes in <strong>office cleaning services</strong>.  We know that the service we provide is a reflection of you.  You can be assured that our primary objective is to perform our services in a way that will enhance your image. Our  account managers and cleaning teams are professional and well informed.  They will communicate any cleaning issues they may come across.</p>
        <div class="blog_list enumerated">
            ...
            <div>
                <ul>
                    ...
                    <li>During the site survey our account manager will take note of your cleaning needs.  As well as make suggestions to further enhance your building.</li>
        ...
        <img class="fifty" src="<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/2016/01/iStock_000005853930_Large.jpg" alt="Clean Office" />
        <div class="forty">
            <ul>
