...
<div class="entry-content" itemprop="text">  <style>
                                    ...
                                    <div class="slider_window marketonlyreel">
                                        <section id="slider_container">
                                            ...
                                            <ul id="slider">
                                                <li class="slide">
                                                    <img class="slide_img" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/07/Conference-Room-Clean-100.jpg" alt="commercial conference room" alt="">
                                                </li>
                                                <li class="slide">
                                                ...
                                                <li class="slide">
                                                    <img class="slide_img" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/07/Conference-Room-Clean-100.jpg" alt="commercial conference room">
                                                </li>
                                                <li class="slide">
                                                    <img class="slide_img" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/09/Office-Entry-100.jpg" alt="commercial office entry">
                                                </li>
                                                <li class="slide">
                                                    <img class="slide_img" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/09/Carpet-Cleaning-100.jpg" alt="commercial carpet cleaning">
                                                </li>
                                                <li class="slide">
                                                    <img class="slide_img" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/08/Commercial-100.jpg" alt="commercial building">
                                                </li>
                                                ...
                                                <li class="slide">
                                                    <img class="slide_img" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/09/Office-Entry-100.jpg" alt="commercial office entry" alt="">
                                                </li>
                                            </ul>
                                        </section>
                                        <div class="slider_info">
                                            <h1 class="title slider_text">Clean your air in circulation!<br><div class="subtext"></div></h1>
                                ...
                                <tr>
                                    ...
                                    <li>Provide Emergency Cleaning (Fire, Flood, Etc)</li>
                                            ...
                                            <div class="blog_list bullets">
                                                ...
                                                <ul style="text-align: left;">
                                                    <li>Antimicrobial chemicals include sanitizers, disinfectants, and deodorizers that can be applied to non-porous surfaces in HVAC systems to address microbial contamination and help control odors. 
