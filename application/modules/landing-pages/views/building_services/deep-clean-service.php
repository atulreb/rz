...
Deep Cleaning</h1>
                ...
                <ul>
                    ...
                    <li>Tenant Ready Services</li>
                    <li>Vacancy Buildings</li>
                    <li>Miscellaneous cleanup such as high ceiling dusting, cob web removal, and lightbulb replacement.</li>
                </ul>
                <br>
               ...
               RazorClean Building Services has a post construction team that is dedicated professional, and experienced. We have a proven record of accomplishment along with the capability of accurately estimating job costs, proactive scheduling, and meeting all completion milestones and dates. 
                ...
                <ul>
                    <li>Washing and Wiping Down all Vertical and Horizontal Services</li>
                    <li>High Dusting: Vents, Light Fixtures, and Duct Work</li>
                    <li>Vacuuming All Carpeted Surfaces</li>
                    <li>Floor Cleaning</li>
                    <li>Window and Glass Cleaning including scraping paint</li>
                </ul>
                <br>
                ...
                <ul>
                    ...
                    <li>Removing dead bugs</li>
                    <li>High and low dusting</li>
                    <li>Lightbulb replacement</li>
                    <li>Stock all paper and soap dispensers</li>
                </ul>
                <br>
