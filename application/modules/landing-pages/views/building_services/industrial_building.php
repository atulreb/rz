            ...
            <main class="content">
                <article class="post-2573 page type-page status-publish entry" itemscope itemtype="http://schema.org/CreativeWork">
                    ...
                    <div class="entry-content" itemprop="text">  <style>
						...
						<!--div class="poster_title slider_text">The experts in janitorial services<div class="subtext"></div></div--></div>
                        <div class="slider_window" style="background-image:url(<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/09/gray-warehouse-100.jpg);    background-size: 100% 100%;    background-repeat: no-repeat;">
                        ...
                        <div class="sixty">
                            <div class="info_block">
                                <h1>Cleaning Industrial Buildings:</h1>
                                <img class="ninty" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_ib1.jpg" alt="Clean Office" />
                                <p>An industrial building houses all types of machinery and provides a variety of products. When such a building is messy, it increases safety risks for employees, makes it harder to do work, and can put the quality of work at risk. Any industrial building should make sure that every area remains clean. This is not just on the employees, though. It is on the employer to have a janitorial service come through and do a full cleaning. Our services are what every industrial building needs to continue working and to continue providing high quality results. It is an essential piece of keeping everything moving.</p>
                                <img class="ninty" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_ib2.jpg" alt="Clean Office" />
                                <p>The machinery in an industrial building is large and dangerous. Everyone knows this. You do not have to work in one to know how dangerous such machinery is when used improperly or when the machinery is not in good condition. Maintenance and proper use of the machinery is an important part of keeping everyone safe and working, but cleanliness is another. When the area is not clean, dirt, grime, debris, and anything else around may move to the machinery. This could cost a lot of money in damages while also making it harder for everyone to do their jobs.</p>
                                <p>Safety, too, is at risk when an area is unclean. Employees around malfunctioning machinery or unclean spaces are at a higher risk of injury or death. They may slip or face injury if something goes wrong. Keeping the entire location clean reduces these risks significantly. The quality of the work can go down, as well. Products on dirty surfaces are worse immediately. Products that go through dirty environments and that are shipped in poor condition are worse. These are avoidable problems. By keeping the area clean, you can make sure that all products that leave the line are in top condition. It does not matter what goes through the line or what is being made, keeping every part of the building clean to keep the products in good shape.</p>
                                <p>Janitorial services will make sure that everything meets your high standards. Risks are lowered and everyone can continue working without concern. You have people who can provide excellent work cleaning the entire facility. Contact us now to make use of such work. We have people who are ready to help, providing the best cleaning services available. You can trust that we will get your industrial building into top shape and maintain that.</p>
                                <h3>Warehouses And Etc.</h3>
                                <p>Janitorial services for warehouses and various industries area require cleaning methods that adhere to EPA standards and regulations. RBS offers a team of sanitation specialists who are experienced in the safe and effective cleaning of any industrial setting.</p>
                                <p>Depending on the type of business, industrial cleaning may routinely involve the handling and disposal of flammable, toxic or other hazardous materials best managed by an expert. Some warehouses require systematic disinfecting and decontamination, while others depend on general and reliable cleaning and maintenance that conform to prevailing standards.</p>
                                <h3>Industrial Cleaning That Keeps Employees and The Work Environment Safe</h3>
                                <p>Whatever your needs, RBS customizes warehouse and facility cleaning services according to controlled and documented criteria, providing detailed reports when required. Ensure the safety and productivity of your employees and visitors with qualified industrial cleaning services that include:</p>
                                <ul>
                                    <li>Wall cleaning</li>
                                    <li>Ceiling cleaning</li>
                                    <li>Pressure washing</li>
                                    <li>Shelf and Bin cleaning</li>
                                    <li>Exterior facility cleaning</li>
                                    <li>Exits, entrance and lobby</li>
                                    <li>Food area decontamination</li>
                                    <li>Carpet Cleaning and vacuuming</li>
                                    <li>Showroom</li>
                                    <li>Floor scrubbing</li>
                                    <li>Lighting fixtures</li>
                                    <li>Washroom sanitization</li>
                                    <li>Equipment sanitization</li>
                                    <li>Work surface disinfecting</li>
                                    <li>Ventilation systems cleaning</li>
                                    <li>Safe and efficient waste disposal</li>
                                </ul>
                                <h3>Avoid Penalties for Non-Compliance with Reliable Industrial Cleaning</h3>
                                <p>A responsible industrial cleaning company puts safety first. RBS provides advanced cleaning solutions and equipment, along with detailed assessments for cleaning regimens adjusted to the requirements of our clients.</p>
                                <p>Fully bonded and insured, our cleaning technicians are trained to handle the many variables involved when maintaining an industrial and warehouse location, and they are trained to ensure safety when handling heavy equipment and industrial materials industrial materials.</p>
