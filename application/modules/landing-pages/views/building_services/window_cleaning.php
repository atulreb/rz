    ...
    <div class="slider_window">
        ...
        <div class="sixty read_more">
            <div class="info_block">
                <h1 class="sub_title">RazorClean Is The Clear Choice</h1>
                <img class="ninty" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_wc1.jpg" alt="" />
                <p>Getting your windows cleaned in your place of business is important. We are very efficient at the process of commercial window cleaning. All our professional window cleaners have been trained directly to uphold high quality standards, and have years of experience in the field. Our staff has the experience to give close attention to detail. The quality of our work and service will reflect this experience and commitment. After the window cleaning is done we perform a final walk through around your place of business to double check your windows and put all your furniture back in place.</p>
                <p>We do courtesy call verifications with every customer, at the end of each job from our main office. We want to make sure that the job is done right for you!</p>
                <p>We strive to change the way you think about professional window cleaning services. In the window cleaning industry, many expectations and experiences have not been positive. We stand by our expert service and we pride ourselves on great customer satisfaction.</p>
                
                <img class="ninty" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_wc2.jpg" alt="" />
                <p>We are fully insured to give you peace of mind. We always make sure that you are protected from top to bottom. Our pricing is always easy to understand and fair. If you have any questions or concerns we are more than happy to address anything that might be unclear. We offer free estimates and there are no gimmicks & no hidden costs.</p>
                
                
                <h3 class="title-description">RBS provides a customized cleaning regimen for any sized corporate office or financial institution and provides:</h3>
                <ul>
                ...
                <h3 >Keeping Your Business Image Clean </h3>
                <p>RBS provides commercial window washing services for:</p>
                <ul>
                    <li>Schools</li>
                    <li>Hospitals</li>
                    <li>Strip malls</li>
                ...
                <br>
                <h3 >Reliable window washing with no streaks!</h3>

                <p>Our window washing team never interferes with your business activity when carrying out specialized commercial cleaning programs for both your interior and exterior windows. Our fully insured and experienced cleaning crews can handle the most challenging jobs with state-of-the-art window cleaning tools that include a combination of industrial squeegees, hand brushes, and specialized apparatus for high rise buildings that keep workers, visitors, and occupants safe. </p>
                <br>
