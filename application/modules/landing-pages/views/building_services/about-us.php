...
<div class="entry-content" itemprop="text"><div class="thirty">
...
<div class="sixty">
<div class="ilblock">
<h1>Knight Janitorial Services &#8211; About Us</h1>
Knight Janitorial Services is a commercial cleaning company. We provide outstanding customer service to any business. Our high standards of cleaning are what allowed us to receive numerous awards and recognition.  We are a BBB Accredited Business that has an A+ rating.  It is Knight Janitorial Services&#8217; top priority to offer the best customer service possible to all of our clients.
  <style>
.yt_container
    {
        position: relative;
    ...
    .youtube .play {
    background: url("<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/2015/08/ic_play_circle_filled_3x.png") no-repeat center center;
...
//        $(this).css('background-image', 'url(http://www.knightjanitorial.com/wp-content/uploads/2015/08/Adam-Poster.jpg)');
...
<div class="yt_container"><div id="UUbARkVxCp8" class="youtube" style="background: url('<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/2015/08/Adam-Poster-1024x577.jpg'); background-size: 100% 100%; width: 100%; height: 100%; padding-top: 0%; position: absolute; left: 0; top: 0;" tabindex="2" data-params="modestbranding=1&amp;rel=0&amp;showinfo=0&amp;controls=0&amp;vq=hd720"></div></div>
<h2>Knight Janitorial Services Mission Statement</h2>
It is our mission to provide the highest quality of service.  To be extremely thorough in the service we provide.  To be very receptive to any client questions or concerns.  To ensure customer satisfaction.  Above all else, to fulfill these responsibilities while maintaining the highest ethical standard.
<h3>Insured and Bonded</h3>
Knight Janitorial Services maintains general liability insurance.  We also maintain medical expense insurance, personal injury insurance, and an automobile liability insurance.  All of which are under an umbrella and we have a business services bond.
<h4>Green Cleaning Program from Knight Janitorial Services</h4>
Cleaning and maintaining your facility with environmentally preferred products minimizes VOC emissions and allergens.  Excluding certain dyes and fragrances results in an indoor environment that is clean and safer.  We want your place of business to be more pleasant and safer for workers, tenants, and employees.  A green cleaning program shows your concern for your employees, building, and occupants.  It improves indoor quality.  Eliminates sick building syndrome and minimizes exposure to aggressive chemicals.
<h4>Steps for Green Cleaning program:</h4>
Knight Janitorial has a goal to provide sustainable products.  Increase air quality inside of your building.  We believe listed efforts below will accomplish this goal:
<ul>
	<li>Using microfiber cloths for cleaning.</li>
	<li>Using green sealed certified cleaning products.</li>
	<li>Using concentrates when possible.</li>
	<li>Using chemical dispensing units to ensure appropriate chemical amounts.</li>
</ul>
<div class="blog_list">
<h2>We specialize in these types of buildings:</h2>
<ul>
...
<div class="blog_list">
<h2>We can also service your building with:</h2>
<ul>
	<li>Floor Maintenance</li>
	<li>Day Porter Service</li>
	<li>Construction Cleanup</li>
	<li>Warehouse Scrubbing</li>
	<li>Power Washing</li>
</ul>
</div>
<div id="read_more_toggle" class="pop" style="clear: both;">Get A Quote!</div>
</div>
