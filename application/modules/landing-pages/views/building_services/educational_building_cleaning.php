...
<div class="entry-content" itemprop="text">  <style>
    ...
    <div class="slider_window" style="background-image:url(<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/08/School-Hallway-Clean-100.jpg);    background-size: 100% 100%;    background-repeat: no-repeat;">
        ...
        <div class="sixty read_more">
            <div class="info_block">
                <h1 class="sub_title">Cleaning Educational Buildings:</h1>
                <img class="ninty" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_ebs1.jpg" alt="" />
                <p>A building for education should focus on learning and improving the minds of the students. To do this, it is imperative that the location remain clean and free of distractions. Distractions can include dirt, messes, and disorganization. Removing these distractions is not a job for teachers or students; it is something that qualified and capable janitorial services should handle. Trusting in these services will ensure that the building remains clean and organized always. It allows everyone inside to remain focused on education, whether they are the teachers or the students. Everyone can remain on task and continue to do what they need to do.</p>
                
                <br>
                 <img class="ninty" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_ebs2.jpg" alt="" />
                <p>Education should always be top priority for any education building. Keeping the focus on education is about more than a great staff, however. You should remember that, no matter how good the teachers and support staff are, they cannot make up for a building that is dirty and not organized. It can cause a large amount of distractions. Students are not able to keep their attentions on the schoolwork, teachers have more difficulties teaching, and there is less joy in being there. Dealing with this means dealing with the mess. Having RazorClean Building Services come in and clean everything up can help.</p>
                
                <br>
                 <img class="ninty" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_ebs3.jpg" alt="" />
                <p>RBS can take care of all aspects of cleaning and organizing regarding your education buildings. From classrooms to restrooms, you have a talented team ready to get to work. The team can cover everything, including cleaning small messes, tidying up areas that are not organized, RBS can do all of this without interfering with the staff's work. You will not have to worry about the janitorial staff making a mess of teachers' work or the work of any other staff member.</p>
                <p>Our janitorial services are top of the line. Our team has years of experience and knowledge to back them up, as well as some exceptional products and equipment. By choosing us, you are choosing people who know how to do their job. Every education building should have the image and cleanliness expected of it. For everyone to gain the most from an education setting, a good environment is necessary. This is only possible when you have the right people there by your side and helping you every step of the way. RazorClean, The Circle Of Trust, Save Money Live RazorClean.</p>
