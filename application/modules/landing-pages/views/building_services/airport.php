...
<div class="entry-content" itemprop="text">  <style>
  .slider_text {
	   ...
	   <!--div class="poster_title slider_text">prevent patient exposure to pathogens that can linger on surfaces for months<div class="subtext"></div></div--></div>
<div class="slider_window" style="background-image:url(<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/09/airport.jpg);    background-size: 100% 100%;    background-repeat: no-repeat;">
...
<script>    
        setInterval(function(){document.getElementById('entry_1257225578').value = screen.width;},1500);
</script></div>
<div class="sixty read_more">
    <h1 class="subject">Cleared By RazorClean for Landing</h1>
	 <img class="ninty" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_ac1.jpg" alt="grime being removed" />
    <p class="info_block">Your travelers may not always notice our cleaning teams working hard across the airport, but they will certainly notice their gleaming work. Our subtlety, however, doesn’t mean we’re any less meticulous about how we look. If anything, we take great pride in our appearance and that of our cleaning equipment. We understand that we are representatives of your facility. Should a traveler have a question or a need, we’re always willing to step up. That’s why every aspect of our intense training also includes customer service techniques.</p>
    <p>Besides maintaining floors and surfaces, our team is also always ready to respond to emergencies and immediate needs. In fact, our response times are measured in minutes, if not seconds. All our systems are also customized to meet the demands of TSA and other security agencies, without interrupting their essential functions. </p>
	<p>Our systems are also designed to work with ever-changing passenger loads. From downtime to full-capacity holiday seasons, the one thing that doesn’t fluctuate is our level of service.</p>
	 <img class="ninty" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_ac2.jpg" alt="grime being removed" />
	<p>We provide airline passengers and employees with a clean airport environment. From conducting targeted cleaning operations at terminal gates following aircraft departures to deep cleaning the floors and offices of our partners, we provide complete attention to detail. We customize our program at each operation to meet the individual needs of our customers.</p>
	
	
	
	
	<h2 class="sub_title">Our Airport Janitorial Services
	</h2>
	<p>Whether in the waiting room, parking lot or the shuttle bus, your RBS operator and the whole team support your mission with seamless commercial cleaning and specialized services and benefits for your airline.</p>
    <ul>
        <li>General cleaning – offices, lobbies, public areas, restrooms, walkways and passageways </li>
        <li>Detailed elevator, escalator and moving walkway cleaning </li>
        <li>Maintenance for resilient and non-resilient flooring </li>
        <li>Marble </li>
        <li>Tile </li>
        <li>Terrazzo </li>
        <li>Ceramic </li>
        ...
        <li>Green cleaning according to LEED standards</li>
        <li>Uniformed day porter services</li>
        <li>Parking lot sweeping and power washing</li>
        <li>Snow removal</li>
    </ul>
    
   <p>The RazorClean Building Services cleaning crews receive rigorous background checks. They are always uniformed and easily identifiable through their security badge identification. Additionally, the crews are adaptable to your own best security practices and TSA requirements.</p>
   <p>Our goal is to help you provide your clients with a pleasant and reliable experience, beginning at the airport drop off and lasting all the way through the terminal to their seat in the aircraft.</p>
   <h3>RazorClean The Circle Of Trust</h3>
   <p>RazorClean Building Services focus on all elements of commercial cleaning, including attention in the details. When you hire us to clean your airport, we'll:</p>
	<ul>
	<li>Dust flat surfaces – windowsills, baseboards, kickboards under counters</li>
	<li>Remove cobwebs</li>
	<li>Wipe high touch surfaces – door handles, light switches</li>
	<li>Sanitize telephones</li>
	<li>Wiping cabinets, countertops and appliances</li>
	</ul>
   ...
   <p>RBS commercial cleaning franchisees bring the knowledge and experience to the table to be able to maintain the highest sanitation and cleaning standards, which are quintessential to your facility’s safe operation. They’re ready to consult with you to plan, carry out, and maintain your facility’s very serious transportation mission.</p>
   <p>To request a cleaning service proposal or additional information, please contact us today by calling 1-855-GO RZCLN (467-9256) or filling out this brief request for proposal form.</p>
...
</div></div></article></main><aside class="sidebar sidebar-primary widget-area" role="complementary" aria-label="Primary Sidebar" itemscope itemtype="http://schema.org/WPSideBar"><section id="text-7" class="widget widget_text"><div class="widget-wrap">			<div class="textwidget"><a href="../../get-a-quote/index.html"><img src="<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/2015/01/bigquote-btn.png"></a></div>
		</div></section>
