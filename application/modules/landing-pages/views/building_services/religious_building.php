	...
	background-color: #bd252c;
        ...
        .slider_home_button
        {
            display: none;
						...
						<!--div class="poster_title slider_text">Your parking lot is your customer's first impression<div class="subtext"></div></div--></div>
                        <div class="slider_window" style="background-image:url(<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/08/Religious-100.jpg);    background-size: 100% 100%;    background-repeat: no-repeat;">
            ...
            <a href="../../index.html" onclick="__gaTracker('send', 'event', 'outbound-article', '../../index.html', '\n            knightjanitorial.com\n        ');" class="slider_home_button"  target="_blank">
                <h4 class="banner_home_button_link" style="padding:0 !important">RazorClean INc.</h4>
                        ...
                        <div class="sixty read_more">
                            <div class="ilblock">
                                <h1 class="subject" style="text-align: center">Cleaning Religious Buildings:</h1>
                                <img class="ninty" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_r1.jpg" />
                                <p>Some say that religion is all about the faith, that it does not matter what your surroundings are like or where you are, if you have faith. That may be the case however, for a religious building, it is important to maintain an image of cleanliness. </p>
                                <p>RBS will allow you to focus on more important matters regarding your place of worship. Faith and spirituality are major part of what makes a positive experience in a church. Let RBS take care of all the little things that are often overlook until it becomes a major problem. RBS can continue to provide a clean, organized space for visitors, which will reflect positively on these who come to worship. </p>

                                <!-- -->
                                <div class="spacer"></div>
                                <div></div><img style="height:100%" class="ninty" src="<?php echo base_url() ?>media/landing-pages/building-services/wp-content/uploads/2015/12/rbs_r2.jpg"/>
                                <p>Having only the basics and no care for upkeep is not good for any place of faith. Regardless of the faith, those inside should feel warm, invited, and comfortable. Having a clean space can manage that. Whether talking or praying, or taking part in any religious activity, keeping the area clean keeps the mind focus. </p>
                                <p>Doing this alone is not an easy job. When trying to focus primarily on helping visitors, taking the time to clean can be difficult. Therefore you need a service ready company like RBS to come in and take care of your cleaning needs. </p>
                                <p>Our experts understand the janitorial process fully, and know how to clean thoroughly and in a high-quality manner. We do this work without interrupting any spiritual or religious activity and without changing anything in the building itself. Our only goal is to provide you with a clean space that you deserve. </p>
                                <h3>Cleaning Religious Buildings</h3>
                                <p>Faith and spirituality is a major part of what makes a positive experience in a place of worship. The structure itself should continue to provide a safe, organized, and clean space for members and visitors. It reflects positively on the religious experience and the message itself.</p>
                                <h3> Religious Building</h3>
                                <p>RBS provides a warm, invited, and comfortable clean setting for members and visitors. Whether talking or praying, or taking part in religious activities, keeping the area clean keeps sprits up. Everyone inside can keep their minds on what they are hearing and doing rather than thinking about their safety and surroundings. Therefore, the saying goes cleanliness is next to godliness.  </p>
