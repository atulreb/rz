        ...
        <TABLE BORDER="0" WIDTH="620" CELLSPACING="0" CELLPADDING="0">
            <TR>
                ...
                <TD ALIGN="left" VALIGN="top"><BR>
                    <span style="font-family: Arial, Helvetica, Sans-serif; font-size: 28px; line-height: 28px; font-style: bold; font-weight: bold;text-decoration: none;color:#000066">Media Center</span>
                    <BR><BR>
                </TD>
            </TR>
            <TR>
            ...
            <TR>
                ...
                <TD ALIGN="left" VALIGN="top">
                    ...
                    <TABLE BORDER="0" WIDTH="600" CELLSPACING="0" CELLPADDING="0">
                        ...
                        <tr><td colspan="3"> <div class="paginate paginate-dark wrapper">
                    <ul>
                    <?php echo $pg_link; ?>
                    </ul>
                </div></td></tr>
