...
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-2 current_page_item menu-item-9 active"><a title="About Us" href="index.html"><span class="glyphicon Mobile Auto Detailing Service"></span>&nbsp;About Us</a></li>
...
<script>            
	...
	<div class="row">
		<div class="col-lg-12 col-md-12">
							...
							<h1 class="page_header">About Us &#8211; Mobile Auto Detailing Service</h1>
			 
						
			<div class="page_content">
			<div id="lessonCatDesc">			<img width="250" height="179" src="<?php echo base_url()?>media/landing-pages/mobile-detail/wp-content/uploads/2015/06/auto-detailing7.gif" class="img-rounded alignleft wp-post-image" alt="About On-Site Detailing" />			<h3>Mobile Detailing Service</h3>
<p>Professional, mobile auto detailing service is what On-Site Detailing, Inc does. Located in Wilmington, Delaware and Incorporated in 2003 On-Site detailing was developed by Owner and auto enthusiast Demetri Kyranakis who was formerly a sales representative w/ Mercedes Benz. It was here that many would call and ask “where should I take my car to have it cleaned properly?&#8221;. At the time, there was no good answer. Now, On-Site Detailing is the solution! Whether you are at home or at the office, On-Site Detailing comes to you! We strive for perfection on every appointment and welcome everyone’s feedback. Our client base consists of corporate as well as individual clients.</p>
<p>On-Site Detailing – Delaware, Pennsylvania, New Jersey and Maryland’s leading mobile auto detailing service On-Site Detailing comes to your home or office to wash or fully detail your vehicle! Don’t wait in line for a disappointing service at your local car wash. Our employees are certified auto detailers with certificates in automotive appearance. We treat you vehicle like it’s our own, our services start at $29.00! CALL TODAY TO MAKE AN APPOINTMENT.</p>
<h3>WHY USE ON-SITE DETAILING?</h3>
<p>Quality auto detailing service:Qualified, Presentable staff with Certificates in automotive appearance and or several years of Auto Detailing experience. We use only the finest products available. Our Soaps, waxes and cleaners are of the best quality and are environmentally friendly (water based). We always hand wash and dry your vehicle, using separate wash mitts for the top and bottom of the car as well as the wheels. Chamois are used for drying and micro fiber towels for polishing to prevent fine scratches or “swirl marks�? from developing in your vehicles clear coat.</p>
<h3>Mobile detailing service for your convenience</h3>
<p>We Come to your home or office to wash or fully detail your vehicle. Call to schedule an appointment, or become a weekly customer. Our mobile units serve the tri-state area. Our employees do not move your vehicle unless otherwise requested. We can do the job almost anywhere!!!! Our mobile units are self sufficient and include a 100 gallon water source, power generator, even a large tent to shade your vehicle from the sun on hot summer days. Don’t live in a dirty vehicle any longer! Call to make an appointment WE COME TO YOU.</p>
