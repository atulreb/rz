...
.poster_photo
{
  display: none;
       ...
       <div class="poster_photo"><img src="<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/2015/09/Open-Office-100.jpg" alt="big open office space"><div class="poster_title slider_text">Your parking lot is your customer's first impression<div class="subtext"></div></div></div>
<div class="slider_window marketonlyreel">
            <section id="slider_container">
                ...
                <ul id="slider">
                    <li class="slide">
                      <img class="slide_img" src="<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/2016/06/power-washing-parking-lot-roof-200.jpg" alt="power washed roof" alt="">
                    </li>
                    <li class="slide">
                      <img class="slide_img" src="<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/2016/06/power-washing-parking-lot-200.jpg" alt="power washed parking lot">
                    </li>
                    <li class="slide">
                      <img class="slide_img" src="<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/2016/06/power-washing-parking-lot-roof-200.jpg" alt="power washed roof">
                    </li>
                    <li class="slide">
                      <img class="slide_img" src="<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/2016/06/Power-Washing-100.jpg" alt="power washing">
                    </li>
                    <li class="slide">
                      <img class="slide_img" src="<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/2016/06/fire-lane-before-after-200.jpg" alt="power washed fire lane">
                    </li>
                    <li class="slide">
                      <img class="slide_img" src="<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/2016/06/power-washing-parking-lot-200.jpg" alt="power washed parking lot">
                    </li>
                    ...
                    <li class="slide">
                      <img class="slide_img" src="<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/2016/06/Power-Washing-100.jpg" alt="power washing" alt="">
                    </li>
                </ul>
            </section>
            <div class="slider_info">
                <h1 class="title slider_text">Your parking lot is your customer's first impression<br><div class="subtext"></div></h1>
...
<div class="sixty read_more">
    <div class="ilblock">
        <h1 class="subject" style="text-align: center">Perception Is Often Reality</h1>
        <p>A clean and professional looking facility will attract more people to visit, lease, and stay. One of the best ways to get that first positive impression is by regular scheduled power washing. Knight Janitorial has the equipment and expertise to handle any size power washing job you might need on your property. Our team of trained professionals provides a wide range of exterior and interior power washing services for your building. We use the latest in trailer mount power washing technology to carry out all different types and size jobs.</p>
        <!-- -->
        <div class="spacer"></div>
        <div></div><img class="fifty" src="<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/4/0/3/6/40363377/1633274.jpg" alt="Truck with power washing equipment attached" />
        <!-- -->
        <div class="forty">
            <h3 class="sub_title" style="text-align: left;">We specialize in power washing:</h3>
            <ul style="text-align: left;">
                <li>Concrete Cleaning</li>
                <li>Graffiti Removal</li>
                <li>Building Washing</li>
                <li>Plaza Cleaning</li>
            </ul>
        </div>
        <div class="spacer"></div>
        <h3 class="subject">Professional Equipment</h3>
        <p>Our professional equipment gives us the flexibility to handle the most delicate and most tough jobs all while making sure your property is left clean and undamaged. We always take the most cautious approach to cleaning, starting with low pressure and working our way up, if necessary. Give us a try, we promise you’ll agree that we are the best at power washing.</p>
        <div class="spacer"></div>
        <img class="fifty" src="<?php echo base_url()?>media/landing-pages/building-services/wp-content/uploads/4/0/3/6/40363377/2521515.jpg" alt="Power washing wearing a yellow tyvec suit" />
        <ul class="forty">
            <li>Tire Marks</li>
            <li>High Lift Dusting</li>
            <li>Gum Removal</li>
            <li>Restaurant Cleaning</li>
            <li>Dumpster Pad Cleaning</li>
            <li>Most Grease Spots</li>
            <li>Algae Growth</li>
            <li>Accumulated Dirt and Grime</li>
        </ul>
        <div class="spacer"></div>
        <h3 class="subject">We have a fleet</h3>
        <p>We have a fleet of Hotsy trailer mounted, heated power washing units, these units are widely considered the best in the industry. We also have multiple capabilities including 300 gallon water and recovery tanks, lifts and hundreds of feet of hose for the hard to access areas. Serving our clients is our number one goal so, if this is a way that we can do so, please do not hesitate to ask. Our local project managers are more than willing to take this off of your plate and provide a quality to service to appease your owners and tenants!</p>
    </div>
</div>
<style>
#read_more_toggle
