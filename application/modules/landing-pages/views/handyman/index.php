        ...
        <div id="services-background" class="section hide-from-tablet">
            <div id="services-wrap" class="wrap clearboth">
                <div id="services" class="section">
                    <a href="<?php echo base_url()?>handyman/services">
                        <div class="circle yellow-design">
                            <i class="fa fa fa-search font-size"></i>
                            <h2>Most Popular Services</h2>
                            <p>Our most requested services</p>
                        </div>
                    </a>
                    <a href="<?php echo base_url()?>handyman/contactus">
                ...
                <div id="body" class="section">
                    <div id="content" class="eight float-right" itemscope itemtype="http://schema.org/WebPage">
                        ...
                        <div style="background-color: #edeade; padding: 10px;">
                            ...
                            <p><img class="alignright size-full wp-image-13" src="<?php echo base_url()?>media/landing-pages/handyman/wp-content/uploads/2014/11/handyman-services-for-the-home.jpg" alt="handyman-services-for-the-home" width="125" height="125" />We know that you lead a busy lifestyle. Between all of your work, social, and family commitments, it may be difficult to find a few spare minutes for yourself, let alone time to complete any major projects at home. From small jobs like hanging mirrors and cleaning the gutters to full remodeling projects, our network of skilled contractors and handymen is ready to make your life easier.</p>
                        ...
                        <div style="background-color: #edeade; padding: 10px; width: 100%;">
                            <h2>Residential &amp; Commercial Handyman Services</h2>
                            <div>
                                <ul>
                                    <li><a title="Electrical Services" href="<?php echo base_url()?>handyman/services">Electrical Services</a>
                                    </li>
                                    <li><a title="Kitchen Remodeling" href="<?php echo base_url()?>handyman/services">Kitchen Remodeling</a>
                                    </li>
                                    <li><a title="Bathroom Remodeling" href="<?php echo base_url()?>handyman/services">Bathroom Remodeling</a>
                                    </li>
                                    <li><a title="Plumbing" href="<?php echo base_url()?>handyman/services">Plumbing</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <ul>
                                    <li><a title="Drywall &amp; Carpentry" href="<?php echo base_url()?>handyman/services">Drywall &amp; Carpentry</a>
                                    </li>
                                    <li><a title="Power Washing" href="p<?php echo base_url()?>handyman/services">Power Washing</a>
                                    </li>
                                    <li><a title="Decks" href="<?php echo base_url()?>handyman/services">Decks</a>
                                    </li>
                                    <li><a title="Painting" href="<?php echo base_url()?>handyman/services">Painting</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
