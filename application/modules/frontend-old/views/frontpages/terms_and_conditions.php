<!--Banner-Start-->
<header class="Bg_Image_Terms">
    <div class="terms_condition_hearder">
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading">TERMS & CONDITION</h1>
...
<div id="Header_Text">
    <div class="container">
        ...
        <div class="row">
            ...
            <h3><span>Lorem ipsum</span> dolor sit amet</h3>
        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                <ul id="nav-tabs-wrapper" class="nav nav-tabs nav-pills nav-stacked well">
                    <li class="active"><a href="#vtab1" data-toggle="tab">Lorem Ipsum</a></li>
                    <li><a href="#vtab2" data-toggle="tab">Sed ut perspiciatis</a></li>
                    <li><a href="#vtab3" data-toggle="tab">At vero eos et accusamus</a></li>
                    <li><a href="#vtab4" data-toggle="tab">Excepteur sint</a></li>
                    <li><a href="#vtab5" data-toggle="tab">Et harum quidem</a></li>
            ...
            <div class="col-sm-9">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade in active" id="vtab1">
                        ...
                        <h3>Phasellus viverra nulla ut metus varius laoreet</h3>
