    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <form name="frm_newsletter" action="<?php echo base_url(); ?>admin/product-category-list" method="post">
                <div class="x_content">
                    <a title="Add New Category " class="btn btn-info pull-right" href="<?php echo base_url(); ?>admin/product-category-add"><i class="fa fa-plus-circle"></i></a>	
                        ...
                        <tbody>
                            ...
                            foreach ($cat_data as $cat) {
                                ...
                                <tr>
                                    <td>
                            <center>
                                <input name="checkbox[]"  type="checkbox" id="checkbox[]" value="<?php echo $cat['category_id']; ?>" />        
                            </center>
                            </td>
                            ...
                            <td><?php
                                ...
                                ?></td>
                            <td>
                                <a title="Edit Category Details" href="<?php echo base_url(); ?>admin/product-category-edit/<?php echo $cat['category_id']; ?>" class="btn btn-info"><i class="fa fa-edit"></i></a> 
                            </td>
                            </tr>
                            <?php
                        }
