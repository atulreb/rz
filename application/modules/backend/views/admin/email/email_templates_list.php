            ...
            <div class="x_content">
                <a title="Add new blog post" class="btn btn-info pull-right" href="<?php echo base_url(); ?>admin/blog/add-post"><i class="fa fa-plus-circle"></i></a>		
                        ...
                        <tbody>
                            ...
                            <td>
                                <a title="Edit Newsletter Details" href="<?php echo base_url(); ?>admin/edit-email-template/<?php echo $email['email_template_id']; ?>" class="btn btn-info"><i class="fa fa-edit"></i>Edit</a> 
