                        ...
                        if (!empty($docs)) {
                            foreach ($docs as $docs) {
                                ...
                                <tr>
                                    ...
                                    <td class="worktd"  align="left"><?php echo stripslashes($docs['document_path']); ?></td>
                                    ...
                                    <td>
                                        <a download href="<?php echo base_url()."/uploads/training_material/".$docs['document_path'];?>" class="btn btn-success btn-xs"><i class="fa fa-download"></i> Download</a>
                                    </td>
