                        ...
                        if (!empty($orders)) {
                            foreach ($orders as $orders) {
                                ...
                                <tr>
                                    ...
                                    <td class="worktd"  align="left"><?php echo stripslashes($orders['ord_order_number']); ?></td>
                                    <td>
                                        <?php echo stripslashes(intval($orders['purchased'])) . ' items'; ?>
                                    </td>
                                    <td class="worktd"  align="left"><?php echo stripslashes($orders['ord_bill_address_01']) . ', ' .stripslashes($orders['ord_bill_address_02']). ', ' .stripslashes($orders['state']). ', ' .stripslashes($orders['city']); ?></td>
                                    <td>
                                        <?php echo date('d M Y', strtotime($orders['ord_date'])); ?>
                                    </td>
                                    <td>
                                        <b> <?php echo $orders['delivery_option'];
                                        ?></b>
                                    </td>
                                     <td class="worktd"  align="left"><?php echo $global['currency_symbol'] . $orders['ord_item_summary_total']; ?></td>
                                    <td class="worktd" style="text-align:left">
                                        <a class="btn btn-success btn-xs" title="Order Details" href="<?php echo base_url(); ?>admin/order-details/<?php echo $orders['ord_order_number']; ?>">
