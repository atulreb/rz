...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/css/master.css" rel="stylesheet">

        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/plugins/jquery/jquery-1.11.3.min.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/js/modernizr.custom.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/js/jquery.nav.js"></script>
    ...
    <body>
        ...
        <div class="layout-theme animated-css" id="wrapper" data-header="sticky" data-header-top="200">
            ...
            <header class="header header_mod-b">
                ...
                <div class="top-header navbar-header">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="top-header__contacts"><i class="icon icon_mail"></i><a class="header-contacts__link" href="mailto:info@domain.com">info@domain.com</a></div>
                                <div class="top-header__contacts"><i class="icon icon_phone"></i>0800.123.9876</div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="header-language btn-group">
                                    <button type="button" class="header-language__btn dropdown-toggle" data-toggle="dropdown">ENG <span class="caret"></span></button>
                                    <ul class="language-list dropdown-menu list-unstyled" role="menu">
                                        ...
                                        <li class="language-list__item"><a class="header-language__link" href="#">de</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-2 col-xs-12"> <a href="index.html" class="logo"> <img src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/img/logo.png" width="198" height="" alt="logo"></a> </div>
            ...
            <div class="main-slider main-slider_mod-a slider-pro" id="my-slider"
                ...
                <div class="sp-slides">
                    ...
                    <!-- Slide 1 -->
                    <div class="sp-slide">
                        <img class="sp-image img-responsive" src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/slider/3.jpg" height="580" width="1600" alt="slider">
                    ...
                    <!-- Slide 2 -->
                    <div class="sp-slide">
                        <img class="sp-image img-responsive" src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/slider/2.jpg" height="580" width="1600" alt="slider">
                    ...
                    <div class="row">
                        <div class="col-xs-12 text-center">
                            ...
                            <p class="fnt20 fnt-monserrat">
                                ...
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sit amet mollis massa. 
                                Donec sollicitudin libero quis ultrices scelerisque. Maecenas at eros sed sem faucibus varius. 
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi ultrices egestas lacus ut pellentesque. 
                                Vestibulum condimentum velit nisl, eu vehicula urna luctus quis. 
                                Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Sed blandit tincidunt porta. 
                                Maecenas tincidunt imperdiet ligula vel pulvinar. 
                                    ...
                                    <article class="post post_mod-d clearfix">
                                        <div class="entry-main">
                                            <div class="entry-header clearfix">
                                                ...
                                                <h3 class="entry-title ui-title-inner"><a href="blog-details.html">QUALITY services</a></h3>
                                    ...
                                    <article class="post post_mod-d clearfix">
                                        <div class="entry-main">
                                            <div class="entry-header clearfix">
                                                ...
                                                <h3 class="entry-title ui-title-inner"><a href="blog-details.html">STYLE & PERFECTION</a></h3>
                                                <div class="border-decor border-decor_mod-b"></div>
                                            </div>
                                            <div class="entry-content">
                                                <p>Vivamus elementum laoreet lorem. Maecenas er felis sed mollis semper lobortis vitae phasellus commodo libero Vivamus sed dolor. Quisque portitor leo as vitae tincidun rutrum urna turpis nullam consequat.</p>
                                    ...
                                    <article class="post post_mod-d clearfix">
                                        <div class="entry-main">
                                            <div class="entry-header clearfix">
                                                ...
                                                <h3 class="entry-title ui-title-inner"><a href="blog-details.html">cleaning IN TIME</a></h3>
                                                <div class="border-decor border-decor_mod-b"></div>
                                            </div>
                                            <div class="entry-content">
                                                <p>Vivamus elementum laoreet lorem. Maecenas er felis sed mollis semper lobortis vitae phasellus commodo libero Vivamus sed dolor. Quisque portitor leo as vitae tincidun rutrum urna turpis nullam consequat.</p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a class="prettyPhoto" href="https://www.youtube.com/watch?v=DIGfO2Dgc9Y&rel=0">
                                <div class="video-link__img"><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/menu/promo.jpg" width="550" height="250" alt="video"></div>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="video-link__wrap">
                                ...
                                <div class="ui-subtitle-block ui-subtitle-block_mod-a">Sed tempus tempor orc mauris viverra nunc diam
                                    <div class="border-decor border-decor_mod-a mt10"></div>
                                </div>

                                <p class="video-link__text">Maecenas er felis se mollis semper lobortis vitae phasellus commodo libero vamus sed dolor portitor leo as vitae tincidu rutrum urnad.</p>
                                <p class="video-link__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sit amet mollis massa. Donec sollicitudin libero quis ultrices scelerisque. Maecenas at eros sed sem faucibus varius. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi ultrices egestas lacus ut pellentesque. Vestibulum condimentum velit nisl, eu vehicula urna luctus quis.</p>
                                <p><br></p>
            ...
            <!--section class="section-area wow">
                    ...
                    <div class="isotope-frame">
                            <div class="isotope-filter">
                                    <div class="isotope-item renovations"> <img src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/isotop/400x320/1.jpg" width="400" height="320" alt="img">
                                    ...
                                    <div class="isotope-item plumbing"><img src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/isotop/400x320/2.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION </h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item interior"> <img src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/isotop/400x320/3.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item renovations"><img src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/isotop/400x320/4.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item renovations"> <img src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/isotop/400x320/5.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item buildings"> <img src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/isotop/400x320/6.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item interior"> <img src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/isotop/400x320/7.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item interior"> <img src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/isotop/400x320/8.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                                    ...
                                                    <article class="post post_mod-b clearfix">
                                                            <div class="entry-main">
                                                                    ...
                                                                    <div class="entry-media">
                                                                            <a href="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/posts/370x220/1-1.png" class="prettyPhoto">
                                                                                    <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/posts/370x150/1.jpg" width="370" height="150" alt="Foto">
                                                                            </a>
                                                                    </div>
                                                                    <div class="entry-content">
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <div class="tab-content">
                                                    <div class="tab-pane active" id="tab1">
                                                            <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/posts/370x150/1.jpg" height="150" width="370" alt="foto">
                                                            <p>Maecenas er felis se mollis semper lobortis vitae phasellus commodo libero Vivamus sed dolor. Quisque portitor leoa tincidu rutrum urna turpis nullam consequat.</p>
                                                    </div>
                                    ...
                                    <div class="entry-main">
                                        <div class="entry-header clearfix">
                                            ...
                                            <div class="entry-header__wrap no-margin">
                                                <h3 class="entry-title ui-title-inner">LOREM ISPUM </h3>
                                                <div class="border-decor border-decor_mod-b"></div>
                                            </div>
                                        </div>
                                        <div class="entry-media">
            ...
            <div class="section-progress no-bg-color-parallax parallax-yellow wow" id="charstart">
                <ul class="bg-slideshow">
                    <li>
                        <div style="background-image:url(<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/slider/4.jpg)" class="bg-slide"></div>
                    </li>
                        ...
                        <div class="col-md-6">
                            <section class="section-area">
                                ...
                                <div class="clients-wrap">
                                    <div class="clients clients_mod-a"> <a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/brand/1.png" height="57" width="90" alt="brand"> </a></div>
                                    <div class="clients clients_mod-a"> <a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/brand/2.png" height="46" width="111" alt="brand"> </a></div>
                                    <div class="clients clients_mod-a"> <a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/brand/3.png" height="46" width="107" alt="brand"> </a> </div>
                                    <div class="clients clients_mod-a"> <a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/brand/4.png" height="52" width="112" alt="brand"> </a> </div>
                                    <div class="clients clients_mod-a"> <a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/brand/5.png" height="36" width="118" alt="brand"> </a> </div>
                                    <div class="clients clients_mod-a"><a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/media/brand/6.png" height="53" width="120" alt="brand"> </a> </div>
                                </div>
                            </section>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <section class="section_mod-h">
                                <h2 class="ui-title-inner ui-title-inner_small text-uppercase">CONSTRUCTME LTD.</h2>
                                <div class="border-decor border-decor_mod-b border-decor_mod-e"></div>
                                <ul class="list-contacts list-contacts_mod-a">
                                    <li class="list-contacts__item"><i class="icon icon_pin"></i>121 King Street, Melbourne <br>Victoria 3000, AUS</li>
                                    <li class="list-contacts__item"><i class="icon icon_phone"></i>0800.123.9876</li>
                                    <li class="list-contacts__item"><i class="icon icon_printer"></i>123.456.0000</li>
                                    <li class="list-contacts__item"><i class="icon icon_mail"></i><a class="list-contacts__link" href="mailto:info@domain.com">info@domain.com</a></li>
                                    <li class="list-contacts__item"><i class="icon icon_clock"></i>Mon to Sat  ::  0900 - 1900</li>
                                </ul>
                            </section>
                        </div>
                        <div class="col-md-9">
            ...
            <footer class="footer wow">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="footer__section">
                                <div class="footer__logo"><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/img/logo3.png" height="" width="210" alt="logo"></div>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <section class="footer__section">
                                ...
                                <ul class="list-contacts">
                                    <li class="list-contacts__item"><i class="icon icon_pin"></i>Lorem ipsum dolor sit amet <br>consectetur adipiscing elit.</li>
                                    <li class="list-contacts__item"><i class="icon icon_phone"></i>123 456 7890</li>
                                    <li class="list-contacts__item"><i class="icon icon_mail"></i><a class="list-contacts__link" href="mailto:contact.us@domain.com">admin@gmail.com</a></li>
                                    <li class="list-contacts__item"><i class="icon icon_printer"></i>123.456.0000</li>
                                    <li class="list-contacts__item"><i class="icon icon_clock"></i>Mon - Sat : 0900 - 1900 <br>Sun : Closed</li>
                                </ul>
                            </section>
                        </div>
                ...
                <div class="footer-bottom">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="copyright">Copyright © 2017, Razor Clean. All rights reserved.</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/js/jquery-migrate-1.2.1.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/js/waypoints.min.js"></script>
        <script src="http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/js/modernizr.custom.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/js/cssua.min.js"></script>


        <!--SCRIPTS THEME-->

        <!-- Home slider -->
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/plugins/slider-pro/dist/js/jquery.sliderPro.js"></script>
        <!-- Sliders -->
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/plugins/owl-carousel/owl.carousel.min.js"></script>
        <!-- Isotope -->
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/plugins/isotope/isotope.pkgd.min.js"></script>
        <!-- Modal -->
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/plugins/prettyphoto/js/jquery.prettyPhoto.js"></script>
        <!-- Chart -->
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/plugins/rendro-easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
        <!-- Animation -->
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/plugins/scrollreveal/dist/scrollreveal.min.js"></script>
        <!-- Flickr-->
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/plugins/jflickrfeed/jflickrfeed.min.js" ></script>
        <!-- Menu for android-->
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/js/doubletaptogo.js" ></script>

        <!-- Custom -->
        <script src="<?php echo base_url() ?>media/landing-pages/mobile-detail/assets/js/custom.js"></script>
        <script>
