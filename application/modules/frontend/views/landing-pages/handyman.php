...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url() ?>media/landing-pages/handyman/assets/css/master.css" rel="stylesheet">

        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/plugins/jquery/jquery-1.11.3.min.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/js/modernizr.custom.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/js/jquery.nav.js"></script>
    ...
    <body>
        ...
        <div class="layout-theme animated-css" id="wrapper" data-header="sticky" data-header-top="200">
            ...
            <header class="header header_mod-a">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-xs-12"> <a href="index.html" class="logo"> <img src="<?php echo base_url() ?>media/landing-pages/handyman/assets/img/logo3.png" width="250" height="55" alt="logo"></a> </div>
            ...
            <div class="main-slider slider-pro" id="my-slider"
                ...
                <div class="sp-slides">
                    ...
                    <!-- Slide 1 -->
                    <div class="sp-slide">
                        <img class="sp-image img-responsive" src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/slider/2.jpg" height="580" width="1600" alt="slider">
                        ...
                        <h1 class="main-slider__title sp-layer"
                            ...
                            data-show-delay="400"
                            data-hide-delay="400">
                            Handyman Services for The Home
                        </h1>
                    ...
                    <!-- Slide 2 -->
                    <div class="sp-slide">
                        <img class="sp-image img-responsive" src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/slider/1.jpg" height="580" width="1600" alt="slider">
                        ...
                        <h2 class="main-slider__title sp-layer"
                            ...
                            data-show-delay="400"
                            data-hide-delay="400">
                            Commercial Handyman Professionals
                        </h2>
            ...
            <div class="section-area wow" style="position:relative;">
               <div id="cstm-services" style="position:absolute;top:-100px"></div>    
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a class="prettyPhoto" href="https://www.youtube.com/watch?v=DIGfO2Dgc9Y&rel=0">
                                <div class="video-link__img"><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/menu/promo.jpg" width="550" height="250" alt="video"></div>
                            </a>
                        </div>
            ...
            <!--section class="section-area wow">
                    ...
                    <div class="isotope-frame">
                            <div class="isotope-filter">
                                    <div class="isotope-item renovations"> <img src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/isotop/400x320/1.jpg" width="400" height="320" alt="img">
                                    ...
                                    <div class="isotope-item plumbing"><img src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/isotop/400x320/2.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION </h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item interior"> <img src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/isotop/400x320/3.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item renovations"><img src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/isotop/400x320/4.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item renovations"> <img src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/isotop/400x320/5.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item buildings"> <img src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/isotop/400x320/6.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item interior"> <img src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/isotop/400x320/7.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item interior"> <img src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/isotop/400x320/8.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                                    ...
                                                    <article class="post post_mod-b clearfix">
                                                            <div class="entry-main">
                                                                    ...
                                                                    <div class="entry-media">
                                                                            <a href="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/posts/370x220/1-1.png" class="prettyPhoto">
                                                                                    <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/posts/370x150/1.jpg" width="370" height="150" alt="Foto">
                                                                            </a>
                                                                    </div>
                                                                    <div class="entry-content">
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <div class="tab-content">
                                                    <div class="tab-pane active" id="tab1">
                                                            <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/posts/370x150/1.jpg" height="150" width="370" alt="foto">
                                                            <p>Maecenas er felis se mollis semper lobortis vitae phasellus commodo libero Vivamus sed dolor. Quisque portitor leoa tincidu rutrum urna turpis nullam consequat.</p>
                                                    </div>
            ...
            <div class="section-progress no-bg-color-parallax parallax-yellow wow" id="charstart">
                <ul class="bg-slideshow">
                    <li>
                        <div style="background-image:url(<?php echo base_url() ?>media/landing-pages/handyman/assets/media/slider/3.jpg)" class="bg-slide"></div>
                    </li>
                        ...
                        <div class="col-md-6">
                            <section class="section-area">
                                ...
                                <div class="clients-wrap">
                                    <div class="clients clients_mod-a"> <a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/brand/1.png" height="57" width="90" alt="brand"> </a></div>
                                    <div class="clients clients_mod-a"> <a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/brand/2.png" height="46" width="111" alt="brand"> </a></div>
                                    <div class="clients clients_mod-a"> <a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/brand/3.png" height="46" width="107" alt="brand"> </a> </div>
                                    <div class="clients clients_mod-a"> <a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/brand/4.png" height="52" width="112" alt="brand"> </a> </div>
                                    <div class="clients clients_mod-a"> <a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/brand/5.png" height="36" width="118" alt="brand"> </a> </div>
                                    <div class="clients clients_mod-a"><a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/handyman/assets/media/brand/6.png" height="53" width="120" alt="brand"> </a> </div>
                                </div>
                            </section>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="footer__section">
                                <div class="footer__logo"><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/handyman/assets/img/logo3.png" height="" width="210" alt="logo"></div>
        ...
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/js/jquery-migrate-1.2.1.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/js/waypoints.min.js"></script>
        <script src="http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/js/modernizr.custom.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/js/cssua.min.js"></script>


        <!--SCRIPTS THEME-->

        <!-- Home slider -->
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/plugins/slider-pro/dist/js/jquery.sliderPro.js"></script>
        <!-- Sliders -->
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/plugins/owl-carousel/owl.carousel.min.js"></script>
        <!-- Isotope -->
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/plugins/isotope/isotope.pkgd.min.js"></script>
        <!-- Modal -->
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/plugins/prettyphoto/js/jquery.prettyPhoto.js"></script>
        <!-- Chart -->
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/plugins/rendro-easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
        <!-- Animation -->
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/plugins/scrollreveal/dist/scrollreveal.min.js"></script>
        <!-- Flickr-->
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/plugins/jflickrfeed/jflickrfeed.min.js" ></script>
        <!-- Menu for android-->
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/js/doubletaptogo.js" ></script>

        <!-- Custom -->
        <script src="<?php echo base_url() ?>media/landing-pages/handyman/assets/js/custom.js"></script>
        <script>
