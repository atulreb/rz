...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//css/master.css" rel="stylesheet">

        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//plugins/jquery/jquery-1.11.3.min.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//js/modernizr.custom.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//js/jquery.nav.js"></script>
    ...
    <body>
        ...
        <div class="layout-theme animated-css" id="wrapper" data-header="sticky" data-header-top="200">
            ...
            <header class="header">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-3"> <a href="home-1.html" class="logo"> <img src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets/img/logo.png" width="250" height="" alt="logo"></a> </div>
            ...
            <div class="main-slider main-slider_mod-b slider-pro" id="my-slider"
                ...
                <div class="sp-slides">
                    ...
                    <!-- Slide 1 -->
                    <div class="sp-slide">
                        <img class="sp-image img-responsive" src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/slider/2.jpg" height="580" width="1600" alt="slider">
                    ...
                    <!-- Slide 2 -->
                    <div class="sp-slide">
                        <img class="sp-image img-responsive" src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/slider/1.jpg" height="580" width="1600" alt="slider">
                    ...
                    <div class="row">
                        <div class="col-xs-12 text-center">
                            ...
                            <div class="ui-subtitle-block ui-subtitle-block_large text-center">
                               Looking for the best pool servicecompany in Fort Lauderdale FL?You just found it !
                                <div class="border-decor border-decor_mod-b center-element"></div>
                            </div>

                            <p class="fnt20 fnt-monserrat">
                                <i class="fa fa-quote-left" aria-hidden="true"></i>
                                For a wide variety of pool service Fort Lauderdale , cleaning, maintenance and spa repair, 
RazorClean Inc. is your best choice. We are located in Oakland Park, South Florida. 
We serve Fort Lauderdale, Pompano Beach, Wilton Manors, Hollywood, Weston, Lighthouse Point and region. 
Our service technicians, mechanics and specialists know exactly what to do when a repair is needed. 
With a wide range of expertise, RazorClean specialists are able to diagnose, and solve problems quickly and effectively. 
Our company provides prompt, professional pool and spa services at affordable monthly rates. 
When you want to enjoy your pool without all the fuss of maintaining it yourself, leave it up to the pros at RazorClean!
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="banner" id="banner01" style="text-align:center">
                                <div class="banner__description" style="text-align:center">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="section-default border-top">
                                ...
                                <div class="ui-subtitle-block ui-subtitle-block_large text-center">Just choose a plan, and we'll start servicing your pool right away.</div>
                                <div class="carousel_mod-b owl-carousel owl-theme enable-owl-carousel"
                                    ...
                                    <article class="post post_mod-a clearfix">
                                        <div class="entry-media">
                                            <div class="front">
                                                <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/posts/370x220/1.jpg" width="370" height="220" alt="Foto">
                                            </div>	
                                            <div class="_back">
                                                <div class="_back_inner">
                                                    <a href="#">Services</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="entry-main">
                                            <div class="entry-header clearfix">
                                                ...
                                                <div class="entry-header__wrap no-margin">
                                                    <h3 class="entry-title ui-title-inner"><a href="blog-details.html">Premium Full Service</a></h3>
                                                    <div class="border-decor border-decor_mod-b"></div>
                                                </div>
                                            </div>
                                            <div class="entry-content">
                                                <p>Starting at $49.95 per month<br>
No Contracts<br>
Pool Standard Size: 15x30</p>
                                            </div>
                                    ...
                                    <article class="post post_mod-a clearfix">
                                        <div class="entry-media">
                                            <div class="front">
                                                <a class="prettyPhoto">
                                                    <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/posts/370x220/2.jpg" width="370" height="220" alt="Foto">
                                                </a>
                                            </div>	
                                            <div class="_back">
                                                <div class="_back_inner">
                                        ...
                                        <div class="entry-main">
                                            <div class="entry-header clearfix">
                                                ...
                                                <div class="entry-header__wrap no-margin">
                                                    <h3 class="entry-title ui-title-inner"><a href="blog-details.html">Standard Mini Service</a></h3>
                                                    <div class="border-decor border-decor_mod-b"></div>
                                                </div>
                                            </div>
                                            <div class="entry-content" style="padding-bottom: 32px;">
                                                <p>No Contracts<br>
Pool Standard Size: 15x30</p>
                                            </div>
                                            <a class="link" href="blog-details.html">READ MORE</a>
                                    ...
                                    <article class="post post_mod-a clearfix">
                                        <div class="entry-media">
                                            <div class="front">
                                                <a href="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/posts/370x220/3.jpg" class="prettyPhoto">
                                                    <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/posts/370x220/3.jpg" height="220" width="370" alt="Foto">
                                                </a>
                                            </div>	
                                            <div class="_back">
                                                <div class="_back_inner">
                                        ...
                                        <div class="entry-main">
                                            <div class="entry-header clearfix">
                                                ...
                                                <div class="entry-header__wrap no-margin">
                                                    <h3 class="entry-title ui-title-inner"><a href="blog-details.html">Basic Chemical Balance</a></h3>
                                                    <div class="border-decor border-decor_mod-b"></div>
                                                </div>
                                            </div>
                                            <div class="entry-content">
                                                <p>Starting at $39.95 per month<br>
No Contracts Pool<br>
Standard Size: 15x30</p>
                                            </div>
                                            <a class="link" href="blog-details.html">READ MORE</a>
                                        </div>
                                    </article>
            ...
            <div class="row_gallery">
                <div class="row_container">
                    <div class="column_container row_col-sm-3">
                        <div class="row_column-inner ">
                            <div class="row_wrapper">
                                <div class="row_image row_content_element ">
                                    <img src="http://aquabuddypools.com/wp-content/uploads/Pool-Service-Fort-Lauderdale.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="column_container row_col-sm-3">
                        <div class="row_column-inner ">
                            <div class="row_wrapper">
                                <div class="row_image row_content_element ">
                                    <img src="http://aquabuddypools.com/wp-content/uploads/home-7.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="column_container row_col-sm-3">
                        <div class="row_column-inner ">
                            <div class="row_wrapper">
                                <div class="row_image row_content_element ">
                                    <img src="http://aquabuddypools.com/wp-content/uploads/home-8.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="column_container row_col-sm-3">
                        <div class="row_column-inner ">
                            <div class="row_wrapper">
                                <div class="row_image row_content_element ">
                                    <img src="http://aquabuddypools.com/wp-content/uploads/home-10.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a class="prettyPhoto" href="https://www.youtube.com/watch?v=DIGfO2Dgc9Y&rel=0">
                                <div class="video-link__img"><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/video-link/1.jpg" width="550" height="250" alt="video"></div>
                            </a>
                        </div>

                        <div class="col-md-6">
                            <div class="video-link__wrap">
                                <h2 class="ui-title-block">Commercial Premium Full Service</h2>
                                <div class="ui-subtitle-block ui-subtitle-block_mod-a">
                                    <div class="border-decor border-decor_mod-a mt10"></div>
                                </div>

        <p class="video-link__text">RazorClean has a vast experience not only with residential pools, but also, with the largest hotel, condominium and resort pools. Aqua Buddy provides a COMPLETE CARE PROGRAM for commercial pools that provides the same and even more detailed care so that you: the owner, property manager, association member or facility administrator never has to worry about anything again.</p>                        
<p class="video-link__text">With the COMPLETE CARE PROGRAM for commercial pools, not only will the water always be crisp, clean and clear, but it will also be 100% safe and will guarantee the satisfaction and return of your customers.</p>
                               <br>
            ...
            <!--section class="section-area wow">
                    ...
                    <div class="isotope-frame">
                            <div class="isotope-filter">
                                    <div class="isotope-item renovations"> <img src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/isotop/400x320/1.jpg" width="400" height="320" alt="img">
                                    ...
                                    <div class="isotope-item plumbing"><img src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/isotop/400x320/2.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION </h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item interior"> <img src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/isotop/400x320/3.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item renovations"><img src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/isotop/400x320/4.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item renovations"> <img src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/isotop/400x320/5.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item buildings"> <img src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/isotop/400x320/6.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item interior"> <img src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/isotop/400x320/7.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item interior"> <img src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/isotop/400x320/8.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="banner" id="banner01">
                                <div class="banner__description">If you are looking for the best Fort Lauderdale Pool Services?</div>
                                ...
                                <article class="post post_mod-b clearfix">
                                    <div class="entry-main">
                                        <div class="entry-header clearfix">
                                            ...
                                            <div class="entry-header__wrap no-margin">
                                                <h3 class="entry-title ui-title-inner">Leak Detection </h3>
                                                <div class="border-decor border-decor_mod-b"></div>
                                            </div>
                                        </div>
                                        <div class="entry-media">
                                            <a href="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/posts/370x220/1-1.png" class="prettyPhoto">
                                                <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/posts/370x150/1.jpg" width="370" height="150" alt="Foto">
                                            </a>
                                        </div>
                                        <div class="entry-content">
                        ...
                        <!--div class="col-md-4">
                                ...
                                <div class="tab-content">
                                        <div class="tab-pane active" id="tab1">
                                                <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/posts/370x150/1.jpg" height="150" width="370" alt="foto">
                                                <p>Maecenas er felis se mollis semper lobortis vitae phasellus commodo libero Vivamus sed dolor. Quisque portitor leoa tincidu rutrum urna turpis nullam consequat.</p>
                                        </div>
            ...
            <div class="section-progress no-bg-color-parallax parallax-yellow wow" id="charstart">
                <ul class="bg-slideshow">
                    <li>
                        <div style="background-image:url(<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//media/slider/2.jpg)" class="bg-slide"></div>
                    </li>
                            ...
                            <ul class="list-progress list-progress_mod-a list-unstyled">
                                <li class="list-progress__item clearfix">
                                    <div class="list-progress__wrap">
                                        <i class="icon icon1 flaticon-cleaning"></i>
                                ...
                                <li class="list-progress__item clearfix">
                                    <div class="list-progress__wrap">
                                        <i class="icon icon1 flaticon-detergent"></i>
                                        <div class="list-progress__inner">
                                ...
                                <li class="list-progress__item clearfix">
                                    <div class="list-progress__wrap">
                                        <i class="icon icon1 flaticon-swimming-pool"></i>
                                        <div class="list-progress__inner">
                                ...
                                <li class="list-progress__item clearfix">
                                    <div class="list-progress__wrap">
                                        <i class="icon icon1 flaticon-shower-outline"></i>
                                        <div class="list-progress__inner">
            ...
            <section class="section-area section-bg-1 wow" >
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="carousel_mod-a owl-carousel owl-theme enable-owl-carousel" style="padding-top: 60px;"
                                 data-min480="1"
                                 data-min768="2"
                                 data-min992="2"
                                 data-min1200="2"
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="footer__section">
                                <div class="footer__logo"><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets/img/logo3.png" height="" width="210" alt="logo"></div>
...
North Little Rock, AR 72116 </li>
        ...
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//js/jquery-migrate-1.2.1.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//plugins/bootstrap/js/bootstrap.min.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//js/waypoints.min.js"></script>
        <script src="http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//js/modernizr.custom.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//js/cssua.min.js"></script>


        <!--SCRIPTS THEME-->

        <!-- Home slider -->
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//plugins/slider-pro/dist/js/jquery.sliderPro.js"></script>
        <!-- Sliders -->
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//plugins/owl-carousel/owl.carousel.min.js"></script>
        <!-- Isotope -->
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//plugins/isotope/isotope.pkgd.min.js"></script>
        <!-- Modal -->
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//plugins/prettyphoto/js/jquery.prettyPhoto.js"></script>
        <!-- Chart -->
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//plugins/rendro-easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
        <!-- Animation -->
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//plugins/scrollreveal/dist/scrollreveal.min.js"></script>
        <!-- Flickr-->
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//plugins/jflickrfeed/jflickrfeed.min.js" ></script>
        <!-- Menu for android-->
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//js/doubletaptogo.js" ></script>

        <!-- Custom -->
        <script src="<?php echo base_url() ?>media/landing-pages/pool-cleaning/assets//js/custom.js"></script>
        <script>
