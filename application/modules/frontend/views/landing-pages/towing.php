...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url() ?>media/landing-pages/towing/assets//css/master.css" rel="stylesheet">

        <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//plugins/jquery/jquery-1.11.3.min.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//js/modernizr.custom.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//js/jquery.nav.js"></script>
        ...
        <div class="container main-div">
            <div class="row row_bg">
                ...
                <div class="layout-theme animated-css" id="wrapper" data-header="sticky" data-header-top="200">
                    ...
                    <header class="header header_mod-b">
                        ...
                        <div class="top-header navbar-header">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="top-header__contacts"><i class="icon icon_mail"></i><a class="header-contacts__link" href="mailto:signup@razorcleanmaids.com">signup@razorcleanmaids.com</a></div>
                                        <div class="top-header__contacts"><i class="icon icon_phone"></i>1-855-GO-RZCLN (467- 9256) </div>
                                    </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-2 col-xs-12"> <a href="index.html" class="logo"> <img src="<?php echo base_url() ?>media/landing-pages/towing/assets//img/logo.png" width="198" height="" alt="logo"></a> </div>
                    ...
                    <div class="main-slider main-slider_mod-a slider-pro" id="my-slider"
                        ...
                        <div class="sp-slides">
                            ...
                            <!-- Slide 1 -->
                            <div class="sp-slide">
                                <img class="sp-image img-responsive" src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/slider/3.jpg" height="580" width="1600" alt="slider">
                            ...
                            <!-- Slide 2 -->
                            <div class="sp-slide">
                                <img class="sp-image img-responsive" src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/slider/2.jpg" height="580" width="1600" alt="slider">
...
<div id="cstm-about1" style="position:relative">
		<div id="cstm-about" style="position:absolute;top: -80px;"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12 text-center">
                                    ...
                                    <p class="fnt20 fnt-monserrat">
                                        ...
                                        Our motto is treat people the way you would want to be treated. We don't know about you  but we would not want to be stuck on the side of the road without help. We understand that life happens sometimes and everyone needs a break every now and then. So when life throws you a curve ball <br>please call RazorClean Towing at 1-855-GO-RZCLN (467- 9256). 
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="banner" id="banner01">
                                        <div class="banner__description">We will take care of your vehicle just like it was our own. </div>
                                            ...
                                            <article class="post post_mod-d clearfix">
                                                <div class="entry-main">
                                                    <div class="entry-header clearfix">
                                                        <i class="icon icon1 flaticon-car-breakdown"></i>
                                                        <h3 class="entry-title ui-title-inner"><a href="blog-details.html">Towing</a></h3>
                                                        <div class="border-decor border-decor_mod-b"></div>
                                                    </div>
                                                    <div class="entry-content">
                                                        <p>
We will treat you and your vehicle with the utmost respect. If you find yourself in need of towing assistance, RazorClean Towing is happy to help you out! It is never a good time to have car problems, but when it happens we are just a phone call away.
</p>
                                                    </div>
                                            ...
                                            <article class="post post_mod-d clearfix">
                                                <div class="entry-main">
                                                    <div class="entry-header clearfix">
                                                        <i class="icon icon1 flaticon-tow-truck"></i>
                                                        <h3 class="entry-title ui-title-inner"><a href="blog-details.html">Heavy Equipment</a></h3>
                                                        <div class="border-decor border-decor_mod-b"></div>
                                                    </div>
                                                    <div class="entry-content">
                                                        <p>
Having a business where you need to move heavy equipment from one location to another can be a headache at times. At RazorClean Towing we understand this side of business. Don't put you or your employees in danger by attempting to move the equipment yourself. 
</p>
                                                    </div>
                                                    <a class="link" href="blog-details.html">READ MORE</a>
                                                </div>
					    ...
					    <article class="post post_mod-d clearfix">
                                                <div class="entry-main">
                                                    <div class="entry-header clearfix">
                                                        <i class="icon icon1 flaticon-tow-truck-1"></i>
                                                        <h3 class="entry-title ui-title-inner"><a href="blog-details.html">Junk Cars</a></h3>
                                                        <div class="border-decor border-decor_mod-b"></div>
                                                    </div>
                                                    <div class="entry-content">
                                                        <p>
If you have a junk vehicle  in your driveway that you have been needing to get rid of. RazorClean Towing can take it off your hands at no charge, also $cash$ for junk Cars, Trucks & Vans. No title necessary for vehicles 2001 and under. We require a valid drivers license with bill of sale. 
</p>
                                                    </div>
                                                    <a class="link" href="blog-details.html">READ MORE</a>
                                                </div>
                                            ...
                                            <article class="post post_mod-d clearfix">
                                                <div class="entry-main">
                                                    <div class="entry-header clearfix">
                                                        <i class="icon icon1 flaticon-towed-car"></i>
                                                        <h3 class="entry-title ui-title-inner"><a href="blog-details.html">Roadside Assistance</a></h3>
                                                        <div class="border-decor border-decor_mod-b"></div>
                                                    </div>
                                                    <div class="entry-content" style="padding-bottom: 65px;">
                                                        <p>
We know life gets you distracted, and sometimes you forget to check your gas gage every now and then. Don't worry it happens to all of us at lest once.
</p>
                                                    </div>
                                                    <a class="link" href="blog-details.html">READ MORE</a>
                                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <a class="prettyPhoto" href="https://www.youtube.com/watch?v=DIGfO2Dgc9Y&rel=0">
                                        <div class="video-link__img"><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/menu/11.png" width="550" height="300 !important" alt="video"></div>
                                    </a>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="video-link__wrap">
                                        ...
                                        <div class="ui-subtitle-block ui-subtitle-block_mod-a">We are proud to provide fast, friendly and reliable towing
                                            <div class="border-decor border-decor_mod-a mt10"></div>
                                        </div>

                                        <p class="video-link__text">
We will treat you and your vehicle with the utmost respect. If you find yourself in need of towing assistance, RazorClean Towing is happy to help you out! It is never a good time to have car problems, but when it happens we are just a phone call away.  Whether you're at home, work or on the side of the highway, we will respond quickly.  Our friendly dispatchers will dispatch a flatbed or wheel lift wrecker to assist you.  Our drivers are trained with the latest towing technology to insure a safe transport of your vehicle.  If you are stranded with your vehicle, you may ride in our truck to the towing destination, we will tow your vehicle to a mechanic or body shop etc.
</p>
                    ...
                    <!--section class="section-area wow">
                            ...
                            <div class="isotope-frame">
                                    <div class="isotope-filter">
                                            <div class="isotope-item renovations"> <img src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/isotop/400x320/1.jpg" width="400" height="320" alt="img">
                                            ...
                                            <div class="isotope-item plumbing"><img src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/isotop/400x320/2.jpg" width="400" height="320" alt="img">
                                                    <div class="isotope__hover">
                                                            <div class="isotope__inner">
                                                                    <h3 class="isotope__title">EXTERIOR DECORATION </h3>
                                                                    <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                            ...
                                            <div class="isotope-item interior"> <img src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/isotop/400x320/3.jpg" width="400" height="320" alt="img">
                                                    <div class="isotope__hover">
                                                            <div class="isotope__inner">
                                                                    <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                                    <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                            ...
                                            <div class="isotope-item renovations"><img src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/isotop/400x320/4.jpg" width="400" height="320" alt="img">
                                                    <div class="isotope__hover">
                                                            <div class="isotope__inner">
                                                                    <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                                    <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                            ...
                                            <div class="isotope-item renovations"> <img src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/isotop/400x320/5.jpg" width="400" height="320" alt="img">
                                                    <div class="isotope__hover">
                                                            <div class="isotope__inner">
                                                                    <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                                    <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                            ...
                                            <div class="isotope-item buildings"> <img src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/isotop/400x320/6.jpg" width="400" height="320" alt="img">
                                                    <div class="isotope__hover">
                                                            <div class="isotope__inner">
                                                                    <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                                    <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                            ...
                                            <div class="isotope-item interior"> <img src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/isotop/400x320/7.jpg" width="400" height="320" alt="img">
                                                    <div class="isotope__hover">
                                                            <div class="isotope__inner">
                                                                    <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                                    <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                            ...
                                            <div class="isotope-item interior"> <img src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/isotop/400x320/8.jpg" width="400" height="320" alt="img">
                                                    <div class="isotope__hover">
                                                            <div class="isotope__inner">
                                                                    <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                                    <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                                            ...
                                                            <article class="post post_mod-b clearfix">
                                                                    <div class="entry-main">
                                                                            ...
                                                                            <div class="entry-media">
                                                                                    <a href="<?php echo base_url() ?>media/landing-pages/towing/assets//media/posts/370x220/1-1.png" class="prettyPhoto">
                                                                                            <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/posts/370x150/1.jpg" width="370" height="150" alt="Foto">
                                                                                    </a>
                                                                            </div>
                                                                            <div class="entry-content">
                                            ...
                                            <div class="col-md-4">
                                                    ...
                                                    <div class="tab-content">
                                                            <div class="tab-pane active" id="tab1">
                                                                    <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/posts/370x150/1.jpg" height="150" width="370" alt="foto">
                                                                    <p>Maecenas er felis se mollis semper lobortis vitae phasellus commodo libero Vivamus sed dolor. Quisque portitor leoa tincidu rutrum urna turpis nullam consequat.</p>
                                                            </div>
                    ...
                    <div  class="section-banner section-bg-2 wow">
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="banner" id="banner01">
                                        <div class="banner__description">Have Questions? View all Services.</div>
                                        <div class="banner__btn-wrap">
                                            ...
                                            <div class="entry-main">
                                                <div class="entry-header clearfix">
                                                    ...
                                                    <div class="entry-header__wrap no-margin">
                                                        <h3 class="entry-title ui-title-inner">RazorClean Towing </h3>
                                                        <div class="border-decor border-decor_mod-b"></div>
                                                    </div>
                                                </div>
                                                <div class="entry-media">
                                                ...
                                                <div class="entry-content">
                                                    <p>
We will take care of your vehicle just like it was our own. RazorClean Towing has the experience to help you in any automobile break down or emergency road side assistance situation. Our towing technicians are friendly & courteous and wont leave you stuck waiting for help.
</p>
                                                </div>
                                                <a class="link" href="blog-details.html">READ MORE</a>
                                            </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="panel-group accordion" id="accordion-1">
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapse-1" class="panel-collapse collapse in">
                                                <div class="panel-body">
                                                    <p>Maecenas er felis se mollis semper lobortis vitae phasellus commodo libero Vivamus sed dolor. Quisque portitor leoa tincidu rutrum urna turpis nullam consequat.
Fusce eleifend. Donec sapien sed phase lusa . Pellentesque lacus.Vivamus lorem arcu semper duiac. Cras ornare arcu vamus nda leo. Etiam ind arc morbi justo mauris temd pus pharetra interdum at congue semper purus.
                    ...
                    <div class="section-progress no-bg-color-parallax parallax-yellow wow" id="charstart">
                        <ul class="bg-slideshow">
                            <li>
                                <div style="background-image:url(<?php echo base_url() ?>media/landing-pages/towing/assets//media/bg/1.jpg)" class="bg-slide"></div>
                            </li>
                            <li>
                                <div style="background-image:url(<?php echo base_url() ?>media/landing-pages/towing/assets//media/bg/1.jpg)" class="bg-slide"></div>
                            </li>
                                ...
                                <div class="col-md-6">
                                    <section class="section-area">
                                        ...
                                        <div class="clients-wrap">
                                            <div class="clients clients_mod-a"> <a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/brand/1.png" height="57" width="90" alt="brand"> </a></div>
                                            <div class="clients clients_mod-a"> <a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/brand/2.png" height="46" width="111" alt="brand"> </a></div>
                                            <div class="clients clients_mod-a"> <a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/brand/3.png" height="46" width="107" alt="brand"> </a> </div>
                                            <div class="clients clients_mod-a"> <a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/brand/4.png" height="52" width="112" alt="brand"> </a> </div>
                                            <div class="clients clients_mod-a"> <a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/brand/5.png" height="36" width="118" alt="brand"> </a> </div>
                                            <div class="clients clients_mod-a"><a class="clients__link" href="home-1.html"><span class="helper-2"></span><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/towing/assets//media/brand/6.png" height="53" width="120" alt="brand"> </a> </div>
                                        </div>
                                    </section>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="footer__section">
                                <div class="footer__logo"><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/towing/assets/img/logo3.png" height="" width="210" alt="logo"></div>
...
North Little Rock, AR 72116 </li>
                ...
                <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//js/jquery-migrate-1.2.1.js"></script>
                <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//plugins/bootstrap/js/bootstrap.min.js"></script>
                <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//js/waypoints.min.js"></script>
                <script src="http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>
                <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//js/modernizr.custom.js"></script>
                <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//js/cssua.min.js"></script>


                <!--SCRIPTS THEME-->

                <!-- Home slider -->
                <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//plugins/slider-pro/dist/js/jquery.sliderPro.js"></script>
                <!-- Sliders -->
                <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//plugins/owl-carousel/owl.carousel.min.js"></script>
                <!-- Isotope -->
                <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//plugins/isotope/isotope.pkgd.min.js"></script>
                <!-- Modal -->
                <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//plugins/prettyphoto/js/jquery.prettyPhoto.js"></script>
                <!-- Chart -->
                <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//plugins/rendro-easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
                <!-- Animation -->
                <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//plugins/scrollreveal/dist/scrollreveal.min.js"></script>
                <!-- Flickr-->
                <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//plugins/jflickrfeed/jflickrfeed.min.js" ></script>
                <!-- Menu for android-->
                <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//js/doubletaptogo.js" ></script>

                <!-- Custom -->
                <script src="<?php echo base_url() ?>media/landing-pages/towing/assets//js/custom.js"></script>
                <script>
