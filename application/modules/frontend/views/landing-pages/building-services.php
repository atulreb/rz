...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url() ?>media/landing-pages/building-services/assets/css/master.css" rel="stylesheet">

        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/plugins/jquery/jquery-1.11.3.min.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/js/modernizr.custom.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/js/jquery.nav.js"></script>
    ...
    <body>
        ...
        <div class="layout-theme animated-css" id="wrapper" data-header="sticky" data-header-top="200">
            ...
            <header class="header">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-xs-12"> <a href="home-1.html" class="logo"> <img src="<?php echo base_url() ?>media/landing-pages/building-services/assets/img/logo.png" width="250" height="" alt="logo"></a> </div>
                        <div class="col-md-9 col-xs-12">
                            <div class="header-contacts">
                                <div class="header-contacts__item">
                                    <div class="header-contacts__name">Email Support</div>
                                    <div class="header-contacts__info"><a class="header-contacts__link" href="mailto:signup@razorcleanmaids.com">signup@razorcleanmaids.com</a></div>
                                </div>
                                <div class="header-contacts__item">
                                ...
                                <div class="header-contacts__item">
                                    <div class="header-contacts__name">Working Hours</div>
                                    <div class="header-contacts__info">Mon - Fri: 8:00 a.m. - 8:00 p.m.</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="main-slider main-slider_mod-b slider-pro" id="my-slider"
                ...
                <div class="sp-slides">
                    ...
                    <!-- Slide 1 -->
                    <div class="sp-slide">
                        <img class="sp-image img-responsive" src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/slider/1.jpg" height="580" width="1600" alt="slider">
                        ...
                        <h1 class="main-slider__title sp-layer"
                            ...
                            data-show-delay="400"
                            data-hide-delay="400">
                            Construction Cleanup the<br> RazorClean Building Service Way
                        </h1>
                    ...
                    <!-- Slide 2 -->
                    <div class="sp-slide">
                        <img class="sp-image img-responsive" src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/slider/2.jpg" height="580" width="1600" alt="slider">
                        ...
                        <h2 class="main-slider__title sp-layer"
                            ...
                            data-show-delay="400"
                            data-hide-delay="400">
                            Construction Cleaning for <br>a Ready-to-Work Environment
                        </h2>
...
<div id="cstm-about1" class="section-banner  wow" style="position:relative;padding-top:60px;">
		<div id="cstm-about" style="position:absolute;top: -120px;"></div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 text-center">
                            ...
                            <div class="ui-subtitle-block ui-subtitle-block_large text-center">
                                Welcome to RazorClean Building Services, Inc. (RBS)
                                <div class="border-decor border-decor_mod-b center-element"></div>
                            </div>

                            <p class="fnt20 fnt-monserrat">
                                <i class="fa fa-quote-left" aria-hidden="true"></i>
                                RazorClean Building Services Inc. is a premier facilities services firm, offering complete facilities maintenance, custodial services, engineering, grounds/landscaping services, operations, project management services, and snow removal services to federal government, local government, and private sector clients.  We keep facilities operating at peak efficiency for hundreds of clients. RBS helps our clients keep a hold on every aspect of work order management- We achieve this goal through constant focus on the, the tenants, and the owner vested interests of the facility with professional and prompt service.   At RBS an optimal facility environment is our goal by providing fiscal responsibility, and quality control. 
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="banner" id="banner01">
                                <div class="banner__description">We are an experienced and affordable Cleaning Services in your area</div>
...
<div id="cstm-about1" class="section-banner  wow" style="position:relative">
		<div id="cstm-services" style="position:absolute;top: -46px;"></div>
                                ...
                                <div class="carousel_mod-b owl-carousel owl-theme enable-owl-carousel"
                                    ...
                                    <article class="post post_mod-a clearfix">
                                        <div class="entry-media">
                                            <a href="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/posts/370x220/1.jpg" class="prettyPhoto">
                                                <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/posts/370x220/1.jpg" width="370" height="220" alt="Foto">
                                            </a>
                                        </div>
                                        <div class="entry-main">
                                            <div class="entry-header clearfix">
                                                ...
                                                <div class="entry-header__wrap no-margin">
                                                    <h3 class="entry-title ui-title-inner"><a href="blog-details.html">Spotless and streak-free guarantee</a></h3>
                                    ...
                                    <article class="post post_mod-a clearfix">
                                        <div class="entry-media">
                                            <a href="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/posts/370x220/2.jpg" class="prettyPhoto">
                                                <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/posts/370x220/2.jpg" width="370" height="220" alt="Foto">
                                            </a>
                                        </div>
                                        <div class="entry-main">
                                            <div class="entry-header clearfix">
                                                ...
                                                <div class="entry-header__wrap no-margin">
                                                    <h3 class="entry-title ui-title-inner"><a href="blog-details.html">Frame and window sill cleaning</a></h3>
                                                    <div class="border-decor border-decor_mod-b"></div>
                                                </div>
                                            </div>
                                            <div class="entry-content">
                                    ...
                                    <article class="post post_mod-a clearfix">
                                        <div class="entry-media">
                                            <a href="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/posts/370x220/3.jpg" class="prettyPhoto">
                                                <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/posts/370x220/3.jpg" height="220" width="370" alt="Foto">
                                            </a>
                                        </div>
                                        <div class="entry-main">
                                            <div class="entry-header clearfix">
                                                ...
                                                <div class="entry-header__wrap no-margin">
                                                    <h3 class="entry-title ui-title-inner"><a href="blog-details.html">Sign and canopy cleaning services </a></h3>
                                                    <div class="border-decor border-decor_mod-b"></div>
                                                </div>
                                            </div>
                                            <div class="entry-content">
				...
				<article class="post post_mod-a clearfix">
                                        <div class="entry-media">
                                            <a href="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/posts/370x220/4.jpg" class="prettyPhoto">
                                                <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/posts/370x220/4.jpg" height="220" width="370" alt="Foto">
                                            </a>
                                        </div>
                                        <div class="entry-main">
                                            <div class="entry-header clearfix">
                                                ...
                                                <div class="entry-header__wrap no-margin">
                                                    <h3 class="entry-title ui-title-inner"><a href="blog-details.html">Post construction window cleaning</a></h3>
                                                    <div class="border-decor border-decor_mod-b"></div>
                                                </div>
                                            </div>
                                            <div class="entry-content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a class="prettyPhoto" href="https://www.youtube.com/watch?v=DIGfO2Dgc9Y&rel=0">
                                <div class="video-link__img"><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/video-link/1.jpg" width="550" height="250" alt="video"></div>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="video-link__wrap">
                                ...
                                <div class="ui-subtitle-block ui-subtitle-block_mod-a">Construction Cleanup the RazorClean Building Service Way
                                    <div class="border-decor border-decor_mod-a mt10"></div>
                                </div>

                                <p class="video-link__text">When it comes to your construction cleanup projects, you can count on RBS for service that shines. Because at RBS, we approach your construction cleaning projects like we do every other cleaning project: with the client always in mind. From construction debris removal to fine detailing, RBS always keeps your property - and your image - looking spotless.</p>
                                <p class="video-link__text">RBS offers this value-added service with the flexibility to work around your schedule. We work with you and your general contractor without ever inconveniencing tenants, customers or visitors.</p>
                                <br>
            ...
            <!--section class="section-area wow">
                    ...
                    <div class="isotope-frame">
                            <div class="isotope-filter">
                                    <div class="isotope-item renovations"> <img src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/isotop/400x320/1.jpg" width="400" height="320" alt="img">
                                    ...
                                    <div class="isotope-item plumbing"><img src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/isotop/400x320/2.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION </h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item interior"> <img src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/isotop/400x320/3.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item renovations"><img src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/isotop/400x320/4.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item renovations"> <img src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/isotop/400x320/5.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item buildings"> <img src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/isotop/400x320/6.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item interior"> <img src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/isotop/400x320/7.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
                                    ...
                                    <div class="isotope-item interior"> <img src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/isotop/400x320/8.jpg" width="400" height="320" alt="img">
                                            <div class="isotope__hover">
                                                    <div class="isotope__inner">
                                                            <h3 class="isotope__title">EXTERIOR DECORATION</h3>
                                                            <a class="btn btn-default btn-effect" href="project-details.html" >View Details</a>
            ...
            <div  class="section-banner section-bg-2 wow">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="banner" id="banner01">
                                <div class="banner__description">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
                                <div class="banner__btn-wrap">
                                ...
                                <article class="post post_mod-b clearfix">
                                    <div class="entry-main">
                                        <div class="entry-header clearfix">
                                            ...
                                            <div class="entry-header__wrap no-margin">
                                                <h3 class="entry-title ui-title-inner">CONSTRUCTION CLEANING </h3>
                                                <div class="border-decor border-decor_mod-b"></div>
                                            </div>
                                        </div>
                                        <div class="entry-media">
                                            <a href="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/posts/370x220/1-1.png" class="prettyPhoto">
                                                <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/posts/370x150/1.jpg" width="370" height="150" alt="Foto">
                                            </a>
                                        </div>
                                        <div class="entry-content">
                                            <p>
RBS post-construction cleaning is not about ordinary dusting and mopping. Our experienced and skilled cleaning team routinely handles large loads of debris along with both the typical and unexpected cleaning requirements of busy building contractors. Experts at removing adhesives, ecologically responsible trash disposal, and the removal of heavy dust from every surface, corner and crevice, we pride ourselves on the reliable services.
</p>
                                        </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapse-1" class="panel-collapse collapse in">
                                        <div class="panel-body">
                                            <p>Fusce eleifend. Donec sapien sed phase lusa . Pellentesque lacus.Vivamus lorem arcu semper duiac. Cras ornare arcu vamus nda leo. Etiam ind arc morbi justo mauris temd pus pharetra interdum at congue semper purus.Fusce eleifend. Donec sapien sed phase lusa . Pellentesque lacus.Vivamus lorem arcu semper duiac. Cras ornare arcu vamus nda leo. Etiam ind arc morbi justo mauris temd pus pharetra interdum at congue semper purus.</p>
<p>Maecenas er felis se mollis semper lobortis vitae phasellus commodo libero Vivamus sed dolor. Quisque portitor leoa tincidu rutrum urna turpis nullam consequat. Fusce eleifend. Donec sapien sed phase lusa . Pellentesque lacus.Vivamus lorem arcu semper duiac. Cras ornare arcu vamus nda leo. Etiam ind arc morbi justo mauris temd pus pharetra interdum at congue semper purus.</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!--div class="col-md-4">
                                ...
                                <div class="tab-content">
                                        <div class="tab-pane active" id="tab1">
                                                <img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/building-services/assets/media/posts/370x150/1.jpg" height="150" width="370" alt="foto">
            ...
            <div class="section-progress no-bg-color-parallax parallax-yellow wow" id="charstart">
                <ul class="bg-slideshow">
                    <li>
                        <div style="background-image:url(<?php echo base_url() ?>media/landing-pages/building-services/assets/media/bg/1.jpg)" class="bg-slide"></div>
                    </li>
                    <li>
                        <div style="background-image:url(<?php echo base_url() ?>media/landing-pages/building-services/assets/media/bg/1.jpg)" class="bg-slide"></div>
                    </li>
                            ...
                            <ul class="list-progress list-progress_mod-a list-unstyled">
                                <li class="list-progress__item clearfix">
                                    <div class="list-progress__wrap">
                                        <i class="icon flaticon-gardening7"></i>
                                ...
                                <li class="list-progress__item clearfix">
                                    <div class="list-progress__wrap">
                                        <i class="icon flaticon-construction16"></i>
                                        <div class="list-progress__inner">
                                ...
                                <li class="list-progress__item clearfix">
                                    <div class="list-progress__wrap">
                                        <i class="icon flaticon-cogwheel33"></i>
                                        <div class="list-progress__inner">
                                ...
                                <li class="list-progress__item clearfix">
                                    <div class="list-progress__wrap">
                                        <i class="icon flaticon-work26"></i>
                                        <div class="list-progress__inner">
            ...
            <section class="section-area section-bg-1 wow" >
                <div class="title-w-bg">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-3">
                                <h2 class="title-w-bg__inner title-w-bg__inner_mod-a">What Our Clients Are Saying</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="footer__section">
                                <div class="footer__logo"><img class="img-responsive" src="<?php echo base_url() ?>media/landing-pages/building-services/assets/img/logo3.png" height="" width="210" alt="logo"></div>
...
North Little Rock, AR 72116 </li>
        ...
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/js/jquery-migrate-1.2.1.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/js/waypoints.min.js"></script>
        <script src="http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/js/modernizr.custom.js"></script>
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/js/cssua.min.js"></script>


        <!--SCRIPTS THEME-->

        <!-- Home slider -->
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/plugins/slider-pro/dist/js/jquery.sliderPro.js"></script>
        <!-- Sliders -->
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/plugins/owl-carousel/owl.carousel.min.js"></script>
        <!-- Isotope -->
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/plugins/isotope/isotope.pkgd.min.js"></script>
        <!-- Modal -->
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/plugins/prettyphoto/js/jquery.prettyPhoto.js"></script>
        <!-- Chart -->
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/plugins/rendro-easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
        <!-- Animation -->
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/plugins/scrollreveal/dist/scrollreveal.min.js"></script>
        <!-- Flickr-->
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/plugins/jflickrfeed/jflickrfeed.min.js" ></script>
        <!-- Menu for android-->
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/js/doubletaptogo.js" ></script>

        <!-- Custom -->
        <script src="<?php echo base_url() ?>media/landing-pages/building-services/assets/js/custom.js"></script>
        <script>
