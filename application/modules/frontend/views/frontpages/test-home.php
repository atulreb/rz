...
<a href="<?php echo base_url()?>foundation" target="_blank">
	<div id="div1" class="targetDiv targetDiv1 fadeInUp animated" >
		<div class="image"><img class="" alt="" src="<?php echo frontend_asset_url() ?>img/loading/foundation.png"/><br>LOADING...</div>
	</div>
</a>

<a href="<?php echo base_url()?>painters" target="_blank">
				<div id="div2" class="targetDiv targetDiv1 fadeInUp animated">
				<div class="image"><img alt="" src="<?php echo frontend_asset_url() ?>img/loading/painter.png"/><br>LOADING...</div>
				</div>
</a>

<a href="<?php echo base_url()?>lawn-care" target="_blank">
				<div id="div3" class="targetDiv targetDiv1 fadeInUp animated">
				<div class="image"><img alt="" src="<?php echo frontend_asset_url() ?>img/loading/lawn-care.png"/><br>LOADING...</div>
				</div>
				</a>
				
<a href="<?php echo base_url()?>building-services" target="_blank">
				<div id="div4" class="targetDiv targetDiv1 fadeInUp animated">
				<div class="image"><img alt="" src="<?php echo frontend_asset_url() ?>img/loading/building-services.png"/><br>LOADING...</div>
				</div>
				</a>

<a href="<?php echo base_url()?>pest-control" target="_blank">
				<div id="div5" class="targetDiv targetDiv1 fadeInUp animated">
				<div class="image"><img alt="" src="<?php echo frontend_asset_url() ?>img/loading/termite.png"/><br>LOADING...</div>
				</div>
				</a>
				
<a href="<?php echo base_url()?>staffing" target="_blank">
				<div id="div6" class="targetDiv targetDiv1 fadeInUp animated">
				<div class="image"><img alt="" src="<?php echo frontend_asset_url() ?>img/loading/staffing.png"/><br>LOADING...</div>
				</div>
				</a>
				
<a href="<?php echo base_url()?>handyman" target="_blank">
				 <div id="div7" class="targetDiv targetDiv1 fadeInUp animated">
				<div class="image"><img alt="" src="<?php echo frontend_asset_url() ?>img/loading/handyman.png"/><br>LOADING...</div>
				</div>
				</a>
				
<a href="<?php echo base_url()?>housekeepers" target="_blank">
				 <div id="div8" class="targetDiv targetDiv1 fadeInUp animated">
				<div class="image"><img alt="" src="<?php echo frontend_asset_url() ?>img/loading/house-keepers.png"/><br>LOADING...</div>
				</div>
				</a>
				
<a href="<?php echo base_url()?>pool-cleaning" target="_blank">
				<div id="div9" class="targetDiv targetDiv1 fadeInUp animated">
				<div class="image"><img alt="" src="<?php echo frontend_asset_url() ?>img/loading/pool-cleaning.png"/><br>LOADING...</div>
				</div>
				</a>
				
<a href="<?php echo base_url()?>security" target="_blank">
				<div id="div10" class="targetDiv targetDiv1 fadeInUp animated">
				<div class="image"><img alt="" src="<?php echo frontend_asset_url() ?>img/loading/security.png"/><br>LOADING...</div>
				</div>
				</a>

<a href="<?php echo base_url()?>transport" target="_blank">
				<div id="div11" class="targetDiv targetDiv1 fadeInUp animated">
				<div class="image"><img alt="" src="<?php echo frontend_asset_url() ?>img/loading/transport.png"/><br>LOADING...</div>
				</div>
				</a>
				
<a href="<?php echo base_url()?>mobile-detail" target="_blank">
			<div id="div12" class="targetDiv targetDiv1 fadeInUp animated">
			<div class="image"><img alt="" src="<?php echo frontend_asset_url() ?>img/loading/mobile-detail.png"/><br>LOADING...</div>
			</div>
			</a>	

<a href="<?php echo base_url()?>towing" target="_blank">
				<div id="div13" class="targetDiv targetDiv1 fadeInUp animated">
				<div class="image"><img alt="" src="<?php echo frontend_asset_url() ?>img/loading/Main_Logo.png"/><br>LOADING...</div>
				</div>
				</a>			
        ...
        <div class="row" style=" margin-right:0px">
            ...
            <div class="tabright col-lg-6" style="padding-bottom: 40px;">
                <div class="customtab mobile-right-tab">
					...
					<div class="pad10perecnt">
					<div class="col-lg-4">
					<div class="button-list text-center ScrollStyle mCustomScrollbar" data-mcs-theme="dark">
					
			   <a class="list-btn"  onclick="getStateJobs('3960')" href="javascript:;">Oklahoma</a>
               <a class="list-btn"  onclick="getStateJobs('3970')" href="javascript:;">Texas</a>
               <a class="list-btn"  onclick="getStateJobs('3922')" href="javascript:;">Arkansas</a>
               <a class="list-btn"  onclick="getStateJobs('3939')" href="javascript:;">Louisiana</a>
               <a class="list-btn"  onclick="getStateJobs('3947')" href="javascript:;">Mississippi</a>
               <a class="list-btn"  onclick="getStateJobs('3919')" href="javascript:;">Alabama</a>
               <a class="list-btn"  onclick="getStateJobs('3974')" href="javascript:;">Virginia</a>
        
			   <a class="list-btn" onclick="getStateJobs('3930')" href="javascript:;">Florida</a>
               <a class="list-btn"  onclick="getStateJobs('3931')" href="javascript:;">Georgia</a>
               <a class="list-btn"  onclick="getStateJobs('3938')" href="javascript:;">Kentucky</a>
               <a class="list-btn"  onclick="getStateJobs('3957')" href="javascript:;">North Carolina</a>
               <a class="list-btn"  onclick="getStateJobs('3966')" href="javascript:;">South Carolina</a>
               <a class="list-btn"  onclick="getStateJobs('3969')" href="javascript:;">Tennessee</a>
               <a class="list-btn"  onclick="getStateJobs('3976')" href="javascript:;">West Virginia</a>
					...
					<div id="statejobsresult">
                        <ul class="jobListing col-lg-7 ScrollStyle mCustomScrollbar" data-mcs-theme="dark" style="padding-left:0px">
