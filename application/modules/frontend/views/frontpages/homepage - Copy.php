    ...
    <div class="row">
        ...
        <div id="sticky" class="col-md-12 col-xs-11">
            <div class="carousel slide media-carousel" id="media1">
				...
				<img alt="" src="<?php echo frontend_asset_url() ?>img/brands/foundation.png"/>
				</div>
				</a>
                                <a class="thumbnail img-hover showSingle" target="1"><img alt="" src=<?php echo frontend_asset_url() ?>img/slider-icons/dark/Foundation.png data-toggle="popover" data-trigger="hover" tabindex="1" data-placement="top" data-container="body"></a>
    				                       
			    </div>

                            <div class="item top-slider">
				<a href="<?php echo base_url()?>painters" target="_blank">
				<div id="div2" class="targetDiv targetDiv1">
				<img alt="" src="<?php echo frontend_asset_url() ?>img/brands/painter.png"/>
				</div>
				</a>
                                <a class="thumbnail img-hover showSingle" target="2"><img src=<?php echo frontend_asset_url() ?>img/slider-icons/dark/Painters.png data-toggle="popover" data-trigger="hover" tabindex="1" data-placement="top" data-container="body" /></a>
				...
				<div id="div3" class="targetDiv targetDiv1">
				<img alt="" src="<?php echo frontend_asset_url() ?>img/brands/lawn-care.png"/>
				</div>
				</a>
                                <a class="thumbnail img-hover showSingle" target="3"><img alt="" src="<?php echo frontend_asset_url() ?>img/slider-icons/dark/Lawn Care.png" data-toggle="popover" data-trigger="hover" tabindex="1" data-placement="top" data-container="body"></a>
				...
				<img alt="" src="<?php echo frontend_asset_url() ?>img/brands/building-services.png"/>
				</div>
				</a>
                                <a class="thumbnail img-hover showSingle" target="4"><img alt="" src="<?php echo frontend_asset_url() ?>img/slider-icons/dark/Building.png" data-toggle="popover" data-trigger="hover" tabindex="1" data-placement="top" data-container="body"></a>
				...
				<img alt="" src="<?php echo frontend_asset_url() ?>img/brands/termite.png"/>
				</div>
				</a>
                                <a class="thumbnail img-hover showSingle" target="5"><img alt="" src="<?php echo frontend_asset_url() ?>img/slider-icons/dark/Pest.png" data-toggle="popover" data-trigger="hover" tabindex="1" data-placement="top" data-container="body"></a>
				...
				<img alt="" src="<?php echo frontend_asset_url() ?>img/brands/staffing.png"/>
				</div>
				</a>
                                <a class="thumbnail img-hover  showSingle" target="6"><img alt="" src="<?php echo frontend_asset_url() ?>img/slider-icons/dark/Staffing.png" data-toggle="popover" data-trigger="hover" tabindex="1" data-placement="top" data-container="body"></a>
				...
				<img alt="" src="<?php echo frontend_asset_url() ?>img/brands/handyman.png"/>
				</div>
				</a>
                                <a class="thumbnail img-hover  showSingle" target="7"><img alt="" src="<?php echo frontend_asset_url() ?>img/slider-icons/dark/handyman.png" data-toggle="popover" data-trigger="hover" tabindex="1" data-placement="top" data-container="body"></a>
				...
				<img alt="" src="<?php echo frontend_asset_url() ?>img/brands/house-keepers.png"/>
				</div>
				</a>
                                <a class="thumbnail img-hover  showSingle" target="8"><img alt="" src="<?php echo frontend_asset_url() ?>img/slider-icons/dark/House Keepers.png" data-toggle="popover" data-trigger="hover" tabindex="1" data-placement="top" data-container="body"></a>
				...
				<img alt="" src="<?php echo frontend_asset_url() ?>img/brands/pool-cleaning.png"/>
				</div>
				</a>
                                <a class="thumbnail img-hover  showSingle" target="9"><img alt="" src="<?php echo frontend_asset_url() ?>img/slider-icons/dark/pool-cleaning.png" data-toggle="popover" data-trigger="hover" tabindex="1" data-placement="top" data-container="body"></a>
				...
				<img alt="" src="<?php echo frontend_asset_url() ?>img/brands/security.png"/>
				</div>
				</a>
                                <a class="thumbnail img-hover  showSingle" target="10"><img alt="" src="<?php echo frontend_asset_url() ?>img/slider-icons/dark/security.png" data-toggle="popover" data-trigger="hover" tabindex="1" data-placement="top" data-container="body"></a>
			...
			<div class="item top-slider">
				...
				<img alt="" src="<?php echo frontend_asset_url() ?>img/brands/transport.png"/>
				</div>
				</a>
                            <a class="thumbnail img-hover  showSingle" target="11"><img alt="" src="<?php echo frontend_asset_url() ?>img/slider-icons/dark/transport.png" data-toggle="popover" data-trigger="hover" tabindex="1" data-placement="top" data-container="body"></a>
			...
			<img alt="" src="<?php echo frontend_asset_url() ?>img/brands/mobile-detail.png"/>
			</div>
			</a>
                            <a class="thumbnail img-hover  showSingle" target="12"><img alt="" src="<?php echo frontend_asset_url() ?>img/slider-icons/dark/mobile-detail.png" data-toggle="popover" data-trigger="hover" tabindex="1" data-placement="top" data-container="body"></a>
                            
		  </div>

                  <div class="item top-slider">
				<a href="<?php echo base_url()?>towing" target="_blank">
				<div id="div13" class="targetDiv" style="left: -90px;">
				<img alt="" src="<?php echo frontend_asset_url() ?>img/brands/towing.png"/>
				</div>
				</a>
                            <a class="thumbnail img-hover  showSingle" target="13"><img alt="" src="<?php echo frontend_asset_url() ?>img/slider-icons/dark/Towing.png" data-toggle="popover" data-trigger="hover" tabindex="1" data-placement="top" data-container="body"></a>
        ...
        <div class="row ">
            <div class="col-lg-6">
                <div class="col-lg-5">
                    ...
                    <p class="text-faded mob-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris</p>
                </div>
                <div class="col-lg-7">
            ...
            <div class="col-lg-5">
                ...
                <hr class="light">
                <p class="text-faded mob-center">Start Bootstrap has everything you need to get your new website up and running in no time! All of the templates and themes on Start Bootstrap are open source, free to download, and easy to use. No strings attached!</p>
                ...
                <a href="#services" class="page-scroll btn btn-default btn-xl sr-button col-lg-offset-1 mob-btn-mem">Why Become A Member</a>
...
<section id="qualities" style="background-color:#f3f3f4;">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4 text-center test">
                <div class="qualitiesIcon1" data-toggle="tooltip" title="Hooray!">

                </div>
                <h3 style="font-weight:800;">Quality</h3>
            </div>
            <div class="col-md-4 col-sm-4 text-center" data-toggle="tooltip" title="Hooray!">
...
<section id="customTabs" style="padding:100px 0 0 0 ">
    <div class="container-fluid" style="padding-right: 0px;">
        <div class="row" style=" margin-right:0px">
            <div class="col-lg-5" style="margin-left:3%; margin-right:5%;">
                ...
                <div class="tabLeft">
                    <div class=" tabIcon">
                        <img src="<?php echo frontend_asset_url() ?>img/RazorCleanShield.png" alt="razorclean" height="60" width="60">
                    </div>
            ...
            <div class="tabright col-lg-6" style="padding-bottom: 40px;">
                <div class="customtab mobile-right-tab">
                    ...
                    <h2 class="mobile-heading-h2" style="text-align:center; padding-top:7%; color:#ed1c24;">&nbsp;Job Listing&nbsp;</h2>
                    <div class="ScrollStyle mCustomScrollbar" data-mcs-theme="dark">
                        <ul class="jobListing" style="padding-left:10%">
                            <?php foreach ($job_data as $job_data1) { ?>
                                <li>
                                    <div class="job_list_icon"><?php echo substr($job_data1['job_title'], '0', '1') ?></div>
                                    <h4 class="col-lg-10" style="color:#ed1c24"><?php echo $job_data1['job_title'] ?> <small style="color:#25aae1;cursor:pointer;" onclick="getJobDesc(<?php echo $job_data1['id']; ?>)"> Job Description</small></h4>
...
<section id="customAreas" class="no-padding bg-red">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="map-image"><a onclick="getStateJobs('3960')" href="javascript:;"><img src="<?php echo frontend_asset_url() ?>img/Oklahoma.png"></a></div>
                <div class="map-image"><a onclick="getStateJobs('3970')" href="javascript:;"><img src="<?php echo frontend_asset_url() ?>img/Texas.png"></a></div>
                <div class="map-image"><a onclick="getStateJobs('3922')" href="javascript:;"><img src="<?php echo frontend_asset_url() ?>img/Arkansas.png"></a></div>
                <div class="map-image"><a onclick="getStateJobs('3939')" href="javascript:;"><img src="<?php echo frontend_asset_url() ?>img/Louisiana.png"></a></div>
                <div class="map-image"><a onclick="getStateJobs('3947')" href="javascript:;"><img src="<?php echo frontend_asset_url() ?>img/Mississippi.png"></a></div>
                <div class="map-image"><a onclick="getStateJobs('3919')" href="javascript:;"><img src="<?php echo frontend_asset_url() ?>img/map/AL.png"></a></div>
                <div class="map-image"><a onclick="getStateJobs('3974')" href="javascript:;"><img src="<?php echo frontend_asset_url() ?>img/map/VA.png"></a></div>
            <div class="clear"></div>
		<div class="map-image"><a onclick="getStateJobs('3930')" href="javascript:;"><img src="<?php echo frontend_asset_url() ?>img/map/FL.png"></a></div>
                <div class="map-image"><a onclick="getStateJobs('3931')" href="javascript:;"><img src="<?php echo frontend_asset_url() ?>img/map/GA.png"></a></div>
                <div class="map-image"><a onclick="getStateJobs('3938')" href="javascript:;"><img src="<?php echo frontend_asset_url() ?>img/map/KY.png"></a></div>
                <div class="map-image"><a onclick="getStateJobs('3957')" href="javascript:;"><img src="<?php echo frontend_asset_url() ?>img/map/NC.png"></a></div>
                <div class="map-image"><a onclick="getStateJobs('3966')" href="javascript:;"><img src="<?php echo frontend_asset_url() ?>img/map/SC.png"></a></div>
                <div class="map-image"><a onclick="getStateJobs('3969')" href="javascript:;"><img src="<?php echo frontend_asset_url() ?>img/map/TN.png"></a></div>
                <div class="map-image"><a onclick="getStateJobs('3976')" href="javascript:;"><img src="<?php echo frontend_asset_url() ?>img/map/WV.png"></a></div>
            
	    </div>

            <div class="col-lg-8 col-lg-offset-2 text-center pdb-60">
            </div>
        </div>
    </div>
</section>
...
$(function(){
	...
	$('#about, header, #Footer, #Footer, #customHeading, #customSocial, #customAreas, #testimonials, #customTabs, #qualities, #portfolio').mouseover(function(){
		$('.targetDiv').hide();
	});
});
});//]]> 
